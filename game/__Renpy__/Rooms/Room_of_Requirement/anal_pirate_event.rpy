label anal_parit_event: #LV.8 (Whoring = 21 - 23)
    ...
    if pathvalue == 0:
        ...
        menu:
            "\"I reckon I'll raise the anchor 'n jus' set sail!\"":
                ...
                call her_head("No, cap'n, Belay that! Ye're nah in open waters--","open","base")
        ...
        menu:
            ...
            "-Spread yer canon fire o'er er hull-":
                ...
                call her_head("Can I my get my share of the booty now, captain?","silly","worried",cheeks="blush",tears="soft")
    ...
    #Third time event.
        ...
        call her_head("Would ye settle down fer me, captain?","angry","down_raised")
        with hpunch
        g4 "{size=+9} WHAT?!{/size}"
        ...
        m "Huh?"
        call her_head("I mean, wit' all that booty plunderin happenin' lately... ah{image=textheart}...","angry","down_raised")
        ...
        menu:
            ...
            "\"I would leave me ship in a heartbeat!\"":
                ...
                call her_head("Aye if only a lass like I, cap'n? So, why neigh me?","soft","base")
                m "Huh?"
            ...
            "\"A pirate not plunderin t' be wit' ye be o' th' picture\"":
                ...
                call her_head("Aye... Aft all th' thin's I had t' do fer me crew...")
