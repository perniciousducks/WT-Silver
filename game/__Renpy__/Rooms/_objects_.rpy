...
default cupboard_OBJ = room_object_class(type="cupboard",
...
default hat_OBJ = room_object_class(type="hat",
...
default candle_right_OBJ = room_object_class(type="candle",
    room_image="candle", room_image_path="images/rooms/_objects_/candles/",
    xpos=833, ypos=225)
