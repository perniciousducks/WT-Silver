...
label saybox_color(day=True):
    if day:
        $ persistent.text_color_day = color_picker(get_rgb_tuple(persistent.text_color_day), False, "Day Text Colour")
        ...
        $ persistent.text_color_night = color_picker(get_rgb_tuple(persistent.text_color_night), False, "Night Text Colour")
