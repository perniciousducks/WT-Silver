...
label letter_intro_hermione:
    ...
    call her_main("Surely you're able to detect them?")
    m "Unfortunately not... I must have been... asleep... when the thing happened..."
    m "I missed my chance, so to speak..."
    call her_main("So how do you expect me to find out who did it?")
    ...
    call her_main("really? You're depending on me to find a criminal student within our school?")
    m "If it's not too much troub-"
    call her_main("I'd be honored [genie_name]!")
    call her_main("It's no doubt the work of one of those despicable \'slytherins\'...")
    call her_main("Nothing would give me greater pleasure than to see scum like that sent to \'Azkaban\'...")
    m "And what's Azkaban?"
    call her_main("...Is this another test sir?")
    m "Sure..."
    call her_main("It's the prison of the damned... An impenetrable rocky outcrop surrounded by the harsh North Sea...")
    call her_main("the guards are the deathly eaters of all happy thoughts and emotions known as dementors...")
    call her_main("They endlessly patrol the prison, devouring all hope from the prisoners, driving them mad within a few days...")
    call her_main("Tormenting them relentlessly for the rest of their miserable lives...")
    call her_main("And the perfect place to house all those dirty \'slytherins\'!")
    m "ah... very good."
    menu:
        "-just tell her to find the student-":
            m "Whatever..."
            m "just find them so we can send them to Akabur..."
            call her_main("Azkaban, sir...")
            m "Just go!"
        "-Tell her you're not going to send them to Azkaban-":
            m "By the gods [hermione_name], what's wrong with you?"
            call her_main("What are you talking about [genie_name]?")
            call her_main("Everyone knows that life in Azkaban is the punishment for casting an unforgivable curse...")
            m "I've been given special permission to punish them as I see fit."
            call her_main("Oh...")
            call her_main("So no Azkaban?")
            m "Not unless they've killed someone..."
            call her_main("Really? So there's still a chance?")
...
label astoria_captured_intro:
    ...
    $ hermione_xpos = 550
    call her_main("Hello sir.","normal","happy")
    m "I thought you said you weren't alone?"
    call her_main("I'm not.","annoyed","glanceL")
    call her_main("Get in here Astoria!","annoyed","angryL")
    ast "No!"
    call her_main("Do you want to make this worse?","annoyed","narrow")
    ast "no..."
    ...
    call ast_main("I never cast Imperio on anyone! I swear sir! Hermione's just being a know-it-all tattle-tail!","surprised","sad","averted","c_pout")
    m "Miss Granger..."
    ...
    call her_main("*hmph*","annoyed","glanceL")
    call her_main("Fine...","base","closed")
    call her_main("I'll go back to my room then...")
    call her_main("Goodbye sir...")
    call her_main("Goodbye Astoria...","grin","glanceL")
    ...
    m "..."
    m "What was that?"
    call ast_main("I just cast Imperio on you professor! Now you have to do everything I say!","halflid","halflid","halflid","c_grin")
...
label tonks_intro_event: #occurs a day or two after the last event
    ...
    m "Ugh..."
    m "Who is it?"
    call ton_main("Nymphadora Tonks sir.","standard","standard","center","default")
    call ton_main("I've been sent by the ministry of magic.","standard","concerned","right","default")
    m "Ah yes... come in."
    call ton_main("Thank you sir... I assume you know why I'm here then?","standard","standard","center","default")
...
label astoria_susan_intro: #have astoria demonstrate the imperio spell for the first time on Susan
    ...
    call ast_main("But I don't want to go to Azkaban! You heard what that nasty lady said!","sad","sad","sad","c_blank")
    ...
    call ast_main("I suppose not... I was pretty angry when I cast it though...","sad","sad","sad","c_blank")
...
label astoria_tonks_intro: #occurs after you get the book from Snape
    ...
    call ton_main("This isn't the time for your stupid jokes Dumbledore!","standard","standard","standard","default")
    ...
    call ton_main("Astoria? You mean that cute little l-{p}lady...","standard","standard","standard","default")
    ...
    call ton_main("If I'd realised the benefits of being a teacher at hogwarts I would have signed up straight away!","standard","standard","standard","default")
    m "benefits?"
    ...
    call ton_main("Awww really... Can't I just use cheats?","standard","standard","standard","default")
    m "..."
