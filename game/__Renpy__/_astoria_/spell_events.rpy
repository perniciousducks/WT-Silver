...
label hornify_spell_1: #first level hornify spell
    ...
    ast "Probably almost as ready as you are to see me use it dumby!"
    m "Well if it's half as exciting as what the name suggests..."
    ast "Then we'll have Susan begging for your dirty, old cock in no time!"
    ast "Maybe I should get a magical photo of her covered in cum!"
    ast "Imagine that in the school paper!"
    m "Magic photos?"
    ast "Haven't you ever read a newspaper Dumby? I thought that's all old people like you did!"
    ast "I wonder if I could take it just as you shoot it all over her..."
    ast "Imagine that for a front page scoop!"
    m "I'm not sure they'd run that story some how..."
    ast "You're the headmaster aren't you Dumby? Make them run it!"
    m "Let's just focus on your magic for the moment, leave the journalism for later."
    ast "Hmph!"
    ast "If you want me to focus on magic then bring those boobs on legs up here so I have someone to practice on!"
    ...
    sus "Ast-"
    ast "Dumby! We haven't even started yet!"
    m "Don't blame me for this, [astoria_name]!"
    ast "I do! I expected you to wait until we started..."
    sus "Excuse me!"
    sus "Why are you sitting on Dumbledore's lap Astoria?"
    sus "And what are you starting?"
    m "We brought you up here to help with a magic experiment."
    sus "Really?"
    sus "B-but that still doesn't explain why Astoria is-"
    ast "IMPERIO!"
    ">With a puff of golden smoke Astoria's wand goes off, entrancing the poor redhead once more..."
    m "Hey, Isn't that the old spell?"
    ast "Of course it is Dumby! Can't you hear things at all?"
    ast "I cast it because I wanna change some stuff about bessy here."
    ast "I think she can still cast spells at us if she wants..."
    ast "Plus I wanna be able to boss her around in class!"
    ast "So listen up Susan!"
    sus "Yes..."
    ast "From now on, you have to do whatever I say, whenever I say, OK?"
    sus "Yes..."
    ast "Awesome!"
    ast "And you can't ever cast a spell on me or Dumby!"
    sus "Yes..."
    ast "And you aren't allowed to play with yourself unless I say!"
    sus "Yes..."
    m "What was that for?"
    ast "Can you imagine how much a big boobed bimbo like Bessy here probably plays with herself?"
    ast "I'm just doing her a favour by giving her some more free time..."
    m "..."
    ast "OK, all done, you can go back to normal now Susy!"
    ">The colour rushes back into Susan's eyes as she snaps back to life."
    sus "-sitting on your lap!"
    ast "I'm sitting here because Dumby refuses to get any comfy furniture!"
    ">You feel astoria's butt adjust ever so slightly, causing the barest bit of friction to your cock..."
    m "Ugh... t-that's right..."
    sus "Ok... so what's this experiment you needed me to help with?"
    ast "Dumby and I want to test the effects of a new spell I just learned!"
    ast "And we needed someone to cast it on..."
    sus "What? I-I'm not so sure about that... What does it do?"
    ast "We're not really sure... All we know is that I have to target it somewhere on your body..."
    ast "Guess where?"
    sus "You don't mean..."
    sus "I don't think I want to help with this experiment Dumbledore! I'm going to leave now..."
    ">Susan turns to leave, but is compelled by Astoria's previous imperio to be unable to leave until excused..."
    sus "I can't... I can't leave!"
    ast "We know! Just get back here and let us cast the spell!"
    sus "..."
    ">Susan begurdgingly walks back in front of your desk, sullenly standing before you and Astoria."
    sus "Whatever you two have done, my aunt-"
    ast "Shhh!"
    sus "..."
    ast "That's better, now I can focus..."
    ast "ready dumby?"
    m "Ready as ever, [astoria_name]..."
    ast "HORNIFY BOOBS!"
    ">With that, a thin bolt of pink electricity jumps from the end of Astoria's wand onto Susan's breasts beforing fading away into them..."
    sus "!!!"
    sus "Ah! what have you done!"
    sus "Where are my clothes!"
    ast "Pfft, you took them off ages ago."
    ast "And I just cast a little spell is all."
    ...
    ast "Dumby..."
    ast "Now what's the spell feel like Susy?"
    sus "Agh... it's like... it's like they're on fire!"
    ast "mmmm.... Bad fire?"
    ">Astoria rolls her hips hard against your cock..."
    ast "Or good fire?"
    sus "{b}Good{/b} fire..."
    ast "And where is the good fire?"
    sus "Ugh... I... I don't want to say?"
    ast "Why not?"
    sus "it's too embarassing!"
    ast "Don't worry, you love being embaressed in front of Dumby and I..."
    ast "It's make's the fire feel even better?"
    ast "{b}doesn't it?{/b}"
    sus "Ah..."
    sus "It's in..."
    sus "My breasts... They feel so..."
    sus "Ah... I need to..."
    ...
    sus "Ah.... w-wow..."
    sus "I've never felt anything like..."
    sus "{image=textheart}{image=textheart}{image=textheart}"
    ...
    ast "Mmmm... your liking this aren't you..."
    ">Before you can respond, Susan issues a defeated response..."
    sus "yes..."
    ">A cheeky grin forms across Astoria's face as she holds her butt firm against your cock."
    ast "Are you going to cum?"
    m "..."
    sus "..."
    ast "Tell me."
    m "y-"
    sus "Ah... yes...{image=textheart}"
    ast "Mmmm..."
    ">Astoria pushes hard into your lap."
    m "Argh..."
    ast "It makes sense a cow like you would cum from having her udders played with..."
    ast "Not to mention when she's doing it in front of her headmaster. *tsk*tsk*tsk*"
    sus "Y-you made me do this!"
    ast "What?"
    ast "You came up here and asked dumby and I to watch you..."
    ast "Didnt you..."
    ">Susan struggles unsuccessfully against the effect of the imperio spell."
    sus "I don't- maybe- I- why?..."
    ast "Because you wanted Dumbledore and I to know what a nasty slut you were..."
    ast "You were so proud about being able to cum from just your big gross tits being played with!"
    sus "I- I'm proud..."
    ">Astoria has begun humping your lap in earnest, punctuating every word with a little thrust."
    ast "You should be!"
    ast "It's not easy cumming from just your tits..."
    ast "Only the biggest sluts can do it!"
    sus "...The biggest..."
    ast "That's right..."
    ast "Now go on..."
    m "Argh..."
    ...
    m "Mmmm... that's it..."
    ast "All done now dumby?"
    m "Yeah... I could go for a nap right about now..."
    ast "Don't fall asleep now old man, we've still got bessy here putting on a show for us..."
    sus "Arghh...{image=textheart}{image=textheart}{image=textheart}"
    sus "I thought..."
    sus "why do...{image=textheart}{image=textheart}{image=textheart} they still feel so {b}gooood{/b}."
    ast "Hmmm... I thought that it would wear off after the first one..."
    ast "Oh well, I'm bored now."
    ">Astoria hops off your lap causing you to notice a huge cumstain on the back of her skirt..."
    ast "!!!"
    ast "DUMBY!"
    m "What?"
    ast "My butt is {b}covered{/b} in your gross cum!"
    m "Well what did you expect after that?"
    ast "Hmph!"
    ast "I expected your robe to stop it all!"
    ast "Clearly a gross old man like you has way too much cum in those big yucky balls of yours!"
    ast "Susan!"
    sus "Y-yes A-Astoria..."
    ast "Clean me up and then go back to class..."
    ast "Oh, and put your clothes on before you go..."
    sus "Clean you... how?"
    ast "Lick it up Bessy!"
    sus "You can't be serious!"
    ">However, Susan's shock and disgust are undermined by her helpless body moving towards Astoria's skirt."
    ast "And make sure you get it all!"
    sus "I-"
    ast "!!!"
    ast "Wow, she's really going for it!"
    sus "..."
    m "..."
    ast "I forgot how big cow's tongues were."
    ...
    ast "Ugh, fine. You better be done Susan."
    ">Susan moves her head away from the Astoria's cute skirt."
    sus "Mhmm..."
    ast "Good, well swallow that and head to class."
    ast "See ya dumby! Lemme know when you want to try out the next spell..."
...
label hornify_spell_2: #second level hornify spell
    ast "Ready to practice that hornify spell again?"
    ...
    ast "Pfft, what's she going to do? Make me try on another cute skirt?"
    ">Astoria gives her hips a quick shake, almost flashing you due to the shortness of it."
    ast "I'm so scared... Now hurry up and get Bessy here, it's almost milking time!"
    m "..."
    ...
    sus "Oh... H-hi astoria... what are you doing here?"
    ast "Getting ready to watch a show..."
    sus "What show?"
    ast "You on your knees while Professor Dumbledore coats you in his sticky, icky cum!"
    sus "What? I don't-"
    ast "Shhhh.... Don't talk unless I tell you to, OK?"
    sus "..."
    ">Susan nods, a terror in her eyes as she gazes down silently at the smiling young blonde."
    ast "Now why don't you kneel in front of me right here..." 
    ast "And dumby, hurry up and get over here!"
    ...
    ast "It's big..."
    pause
    ast "For an old man like you!"
    sus "..."
    ast "Go on then... make it shoot... stuff..."
    ...
    ast "Just wait a sec Dumby, I haven't even cast it yet!"
    sus "???"
    ast "Hornify cum!"
    ...
    ast "Now what this spell does susy, is it makes you feel really good..."
    ast "Once you cover yourself in dumbys gross smelly cum..."
    sus "!!!!!!"
    ast "Until then..."
    ast "Well... you're slutty, little brain won't be able to think of much else..."
    ast "So why don't you help old Dumby out and give him a little show, hmmm?"
    sus "..."
    ast "You can speak now Bessy..."
    sus "..."
    sus "{size=-5}Please sir...{/size}"
    sus "cover me..."
    m "Mmmm, keep shaking those tits of yours and I won't have any other option!"
    ast "hahahaha"
    sus "*sob*T-thank you sir *sob*"
    ast "Awww, is little susy sad that her tits are gonna be covered in cum?"
    sus "..."
    ast "Or maybe you're crying because your headmaster hasn't cum yet...?"
    sus "*sob*I-I am not..."
    ast "So you don't want Dumbledore to cum all over you then?"
    sus "I didn't say that!"
    ast "haha, typical. You Hufflepuff whores are always after one thing."
    sus "..."
    ast "Maybe this would go faster if you sucked on dumbledore's gross old cock..."
    sus "What? You can't be serious! Isn't this enough?"
    ast "I don't know... Is it Dumby?"
    menu:
        "-\"This is fine.\"-":
            ast "*pfft*"
            sus "really?"
            sus "You mean I don't have to..."
            sus "{b}suck{/b} it..."
            m "Not unless you want to. It'd probably speed things up a bit though..."
            sus "..."
            sus "..."
        "-\"Suck it!\"-":
            sus "Professor dumbledore!"
            ast "See! I told you he wants you to suck it!"
            ast "Open Wide slut!"
            sus "..."
            sus "..."
    ...
    ast "Yeah susy, don't be rude to Dumby!"
    sus "But, but-"
    ast "Hornify cock!"
    ...
    ast "There, not so gross now is it Susy?"
    sus "*Slrp*glp*slrp*"
    ...
    ast "Mmmmm, this look suits you susy..."
    sus "*Slrp*glp*slrp*"
    m "Ugh... are you sure you should have cast it twice?"
    sus "*Slrp*glp*slrp*?"
    ast "It'll be fine... Exponential can't be that much more can it?"
    sus "*Slrp*!!!*glp*"
    ast "She's not even feeling them both yet anyway..."
    sus "*Slrp*glp*slrp*"
    ">Susan's mouth softly cradles your cock as she berates the tip..."
    sus "*Slrp*glp*slrp*"
    m "Ugh... I said slow down slut!"
    sus "*Slrp*glp*slrp*"
    ">Susan refuses to acknowledge you, desperate to drain you as fast as she can..."
    ast "Mmmm, that's it bessy..."
    ast "Are you ready yet dumby?"
    m "Ugh... almost there..."
    ">Astoria leans in close to Susan."
    sus "*Slrp*glp*slrp*"
    ast "{size=-5}Hear that? He's going to coat you with his nasty cum...{/size}"
    sus "*Slrp{image=textheart}*glp*{image=textheart}slrp*"
    g4 "ARGH, THAT'S IT YOU LITTLE WHORES!"
    ast "Get ready slut-"
    sus "*Slrp{image=textheart}*!!!*{image=textheart}slrp*"
    ...
    ast "..."
    m "!!!"
    ast "Hahahaha! I guess two times was too much for poor."
    ast "Looks like you were right for once Dumby."
    m "Well we'll know for next time."
    ast "Are you kidding? Someone like Susan deserves way worse than this!"
    m "...(What's she got against this girl?)"
    ast "Good job by the way Dumby, you covered her! I can smell her from here..."
    m "About that..."
    ast "Not now dumby, I wanna wake her up."
    ast "Surgere!"
    ">A brief flash of white appears at the end of Astoria's wand."
    sus "W-w-wha happened? where am I?"
    ast "Don't you remember professor dumbledore's wrinkly old cock coating you in his nasty, smelly cum?"
    ast "Hmmm?"
    sus "I-i Stop-"
    ast "Shhh..."
    sus "!!!"
    ast "I think I'm getting sick of smelling you honestly..."
    ast "Why don't you head back to your room."
    sus "!!!"
    ast "Take the scenic route, I think you'll need the fresh air..."
    sus "!!!"
    ...
    ast "Pfft, no... Besides, Everyone already stares at her big tits, it's not like anything will change..."
    sus "..."
    ast "Bye bye Susy, don't forget to have fun!"
    ast "And no magic to hide or clean up dumbys cum either!"
    sus "......"
    ...
    ast "hahaha, everyone's going to be talking about this for weeks!"
    m "You don't think you're taking this too far?"
    ast "Not far enough! besides, who's going to punish me? you?"
    m "I'm not the one to worry about... Don't forget tonkerbell..."
    ast "I'm sooo scared... What's she going to do?"
    m "She is Susan's aunt."
    ast "And a huge perv like you! I've got her wrapped around my finger."
    m "..."
    ast "Speaking of, I better go see her now..."
    m "Have fun..."
    ast "I will, she's probably got some more cool clothes for me."
    ast "Seeya dumby!"
...
label hornify_spell_3: #third level hornify spell
    ...
    ast "You want to practice that spell don't you?"
    ">Astoria starts shamelessly rolling her hips on your cock."
    ast "I'm just getting ready..."
    ">Your cock hardens in response to physical trauma." #MGSR joke, might remove
    ">Astoria then gives her butt a little wriggle until your cock is resting in-between her butt cheeks."
    ast "There, you can bring susy up here now..."
    m "You're comfortable sitting here then?"
    ast "Hmph, I need something soft after what that meanie Tonks did!"
    ast "Besides, a filthy old man like you should count their lucky stars I'm sitting here..."
    ...
    sus "Hello Professor Dumbledore."
    sus "Oh... um... hello Astoria..."
    sus "You wanted to see me sir?"
    ast "Pfft... you bet he does..."
    ">Astoria wriggles her bum against your cock to make her point..."
    sus "Astoria!"
    ast "Shhhh Susy... just stay still for a sec, OK?"
    ">Susan's bodies stiffens in response to Astoria's lingering spell."
    sus "..."
    ast "You ready to go Dumby?"
    ...
    sus "!!!"
    m "Her uniform?"
    ast "What? You've got a problem with it?"
    m "no, no, it's just a little tame compared to last time..."
    m "Maybe tonks really did teach you a lesson."
    ast "Pfft as if! I wasn't even done yet Dumby!"
    ast "hornify exhibitionism!"
    sus "!!!"
    m "Hmmm, that's a little more interesting..."
    ast "Not done yet!"
    sus "..."
    ast "Susy, walk out and come back in!"
    ">Susan turns and walks outside, closing the large door behind her."
    m "What's that supposed to do?"
    ast "So she forgets about the spells Dumby!"
    ast "This way we can trick her into thinking she came to us..."
    ">With that the door swings open as Susan bones enters."
    sus "Hello Professor Dumbledore."
    sus "Oh... um... hello Astoria..."
    sus "W-Why are you sitting on Dumbledore's lap?"
    ast "Because it's the softest place in the room."
    sus "Oh, ah o-ok then..."
    ">You notice a red flush appear over Susan's face as her thighs slowly start to roll together."
    sus "D-did you want to {b}see{/b} me sir?"
    ast "Don't you remember why you're here susy?"
    sus "U-um... I thought you... I-I guess not..."
    ast "You wanted to show Dumbledore and me your plans for the new Hufflepuff uniform."
    sus "I-I did?"
    ast "Mhmm! Something about the current one being way too prudish!"
    ast "Isn't that right Dumbledore?"
    ">Astoria pushes hard into your cock..."
    m "I do seem to remember the word conservative being thrown around..."
    sus "So you two are going sit there and {b}watch{/b} me..."
    sus "-while I show off my new {b}uniform{/b}..."
    ast "If you don't want t-"
    sus "NO! Ugh... I mean, no, I want to show you..."
    ast "Show us what?"
    sus "My... new uniform..."
    ...
    sus "The first thing I t-think needs to be changed is the s-skirt..."
    ast "Really? How's that?"
    ">Astoria changes her rocking motion from forwards and backwards to side to side."
    sus "I think it needs to be shor-shorter..."
    ast "Shorter?"
    sus "Mhmm..."
    ast "How much shorter?"
    sus "Well, um, a fair-"
    ast "Why don't you show us..."
    ">Astoria presses your cock hard into her buttcrack..."
    m "Ugh..."
    sus "Here?... in front of..."
    ast "Go on..."
    sus "A-Alright..."
    sus "I ugh... think that the skirt should-"
    ">Susan starts to fold it inwards at the belt, causing it to ride up..."
    sus "probably at least..."
    sus "This short..."
    ...
    ">You look down and notice the desperate redheads juices start to drip down from underneath the tiny skirt..."
    sus "I-I don't think so..."
    ast "Really? I can make out your panties!"
    sus "You can?..."
    sus "..."
    ">You notice Susan's thighs squeeze together helplessly in pleasure."
    sus "well a-anyway, I think this is a good length for the hufflepuff uniform..."
    ast "I bet you do..."
    sus "W-what do you think sir?"
    ...
    menu:
        "-Shorter-":
            ...
            sus "Really? Thank you sir..."
            ">With that, Susan starts to roll up her skirt a little more, shamelessly bringing her soaked panties into view..."
            ast "Wow, that took a lot of convincing..."
            ">Astoria speeds up her hips as she starts to bounce on your lap."
            sus "Well it's not my fault the school skirt is so horribly long!"
            ast "Of course not..."
        "-It's fine-":
            m "That's short enough i'd say..."
            sus "Really? You don't want it a little..."
            ast "Dumby! Of course he wants it shorter!"
            sus "b-but he said..."
            ast "You want it shorter, don't you dumby?"
    ...
    sus "T-thank you s-sir..."
    ast "That's not all though is it Susy?"
    sus "N-no..."
    ast "I think you want to change your top as well don't you?"
    sus "Ah... yes... I want to show you... my... {p}ideas..."
    ast "Mmmm... go on then..."
    ">Astoria has shamelessly started to grind against your cock while teasing the poor redhead..."
    sus "First th-things first... The vest needs to go..."
    ast "..."
    ">Astoria silently watches as Susan throws her vest to the ground..."
    ast "What's next?"
    sus "Well I think it should be a rule that..."
    ">Astoria's hips continue to grind against you, a needy heat beginning to emanate from them..."
    sus "You shouldn't be allowed to do up your first two buttons on your shirt..."
    ast "Why's that?"
    sus "Oh... um... it's so that you don't overheat in class..."
    ast "Overheat?"
    sus "Um... as well as it helps to, um..."
    ast "Shhh, keep going..."
    sus "..."
    ">Susan's thighs start to shamelessly drip as she continues to debase her uniform for Astoria and yourself."
    sus "Well... I also think that you should roll the bottom up and through the middle too..."
    ">With that Susan flips her top to make it little more than a tube top in front of the two of you..."
    sus "There... I-I think that this should be the new Hufflepuff uniform..."
    ">With that, Susan stands still, proudly presenting her slutty attire to you and the young blonde grinding on your cock."
    pause
    ast "Is that all?"
    sus "I think so..."
    sus "So what do you think?"
    ast "It'll definitely get rid of the idea that hufflepuff are prudes!"
    sus "..."
    sus "What do you think sir?"
    ...
    ast "Mmmm, Dumby sure feels like he likes it..."
    sus "Feels like-"
    sus "You mean?"
    ast "Yep, his nasty old cock is all hard from having to look at your slutty little uniform..."
    ">A look of both shame and extreme pass over Susan's face as her hips start to quiver..."
    sus "Is it true sir... Do you think this uniform is too {b}slutty{/b}?"
    menu:
        "-Shame her-":
            m "Of course girl!"
            ast "..."
        ...
        "-Be nice...-":
            ...
            ast "Really sir? It wouldn't surprise me if Susy tries to rub one out in class!"
            sus "Astoria! I would never do such a thing sir!"
            sus "Can you imagine what people would say if they s-saw me touching myself in class!"
            sus "There would be talk for weeks about how much of a slut I am and how I should so {b}ashamed{/b}..."
            ">Susan's hips spasm with need..."
            sus "Maybe I shouldn't go to class like this..."
    ast "Nonsense! You have to go to class and show everyone your cute new uniform!"
    sus "I do?"
    ast "Mhmm! How else are you going to get people's opinions about it?"
    sus "Y-you're right!"
    sus "I know, I should make a petition!"
    ast "*pffft*"
    ast "That's a great idea Susie! Why don't you ask as many people as you can about your new uniform!"
    sus "How many do I need to get to make this Hufflepuffs new uniform?"
    menu:
        "-Ten-":
            m "Ten should do."
            sus "Only ten?!"
            sus "I'll have this done before lunch!"
            ast "Yeah, that's not enough Dumby!"
            sus "Astoria!"
            ast "Fine, I guess that just means he must really like your uniform..."
        "-Fifty-":
            m "Fifty signatures would probably be enough..."
            sus "OK sir, I'll try my hardest to get that many!"
        "-One hundred-":
            m "One hundred."
            sus "One hundred?!"
            sus "I can't get one hundred signatures in just one day!"
            sus "Especially not if I go to all my classes..."
            ast "Just skip them!"
            sus "Play hooky?"
            sus "What would everyone think!"
    sus "Well I better get to class..."
    ast "Have fun Susy..."
    ...
    ast "Pfft, I can't wait to hear the rumours going around about Susy the Floozy once she asks for signatures for that uniform!"
    ast "This is going to be great! I'm going to chase her around to see what people say."
    ...
    ast "You mean your- gross!"
    ast "Your lucky I sat on your lap today! If you think I'm going to actually touch that monster of yours..."
    ast "That's what Susie's for!"
    m "Well why didn't you get her to deal with this then?"
    ast "You know what happens if I send her out with your cum all over her..."
    ast "Just be a good headmaster and wait for Susy to come back later today."
