...
label cho_intro_1:
    ...
    menu:
        ...
        "\"Hello, Princess.\"":
            ...
            call cho_main("I’d much prefer if ye called me Cho, or Miss Chang...", "base", "base", "raised", "down")
        ...
        "\"Hey there, Chap.\"":
            ...
            call cho_main("What? Professor how dare ye suggest I'-", "angry", "angry", "raised", "mid")
            g4 "Hold on!"
            ...
            g9 "(Smooth...)"
            call cho_main("Right, well... Since ye seem unable to see very well...", "upset", "angry", "base", "downR")
            m "..."
        ...
        "\"Xiao Hua...\"":
           ...
           call cho_main("But I don’t speak that much Mandarin...{w} Ye see, I was actually born here...", "soft", "base", "base", "mid")
           g4 "Where?"
    ...
    call cho_main("And why'd ye do that, Professor?", "annoyed", "narrow", "raised", "downR")
    ...
    call cho_main("Yes... And ye need to put an end to it, Professor!", "annoyed", "narrow", "angry", "mid")
    m "An end to what?"
    call cho_main("Her{w=0.5} \"Quidditch equality movement\".", "soft", "angry", "angry", "down")
    m "Her what now?"
    call cho_main("I know! It's absolutely ridiculous...{p=0.8}It’s going to ruin the sport for all o' us!", "open", "angry", "sad", "mid")
    ...
    call cho_main("Just as hard as all the other great female Quidditch players o' history!", "scream", "closed", "angry", "mid")
    ...
    call cho_main("It would undermine the whole sport, and I’d get even less attention as one o' the few girls in the league...", "open", "angry", "angry", "down")
    m "Ah, so that’s where the problem lies..."

    call cho_main("Sir, could you please talk to her?", "upset", "base", "raised", "L")
    call cho_main("I'd be very grateful if ye did.{w} I'd be forever in your debt.", "base", "base", "raised", "L")
    ...
    call cho_main("Oh, you know...{w=0.5} Just having a nice blether with our dear headmaster...", "smile", "base", "base", "L")
    ...
    call cho_main("Oh, it’s nothing that ye need to worry your pretty wee head about...", "base", "narrow", "angry", "L")
    ...
    if masturbating:
        ...
        call cho_main("Oh, miss perfect Hermione Granger. Afraid o' using the word tits...", "horny", "narrow", "raised", "downR")
        call her_main("Cho!","scream","wide", cheeks="blush")
        call her_main(".{w=0.3}.{w=0.3}.","mad","worried", cheeks="blush")
        call cho_main("And so what? What’s wrong with being confident about your body... you should try it some time... Ye might even get a boyfriend one day...", "soft", "wide", "base", "L")
        ...
        call cho_main("Yeah? You ever even kissed a boy before Granger?{p=0.8}And I’m talking about a real kiss! And not your daddy kissing ye good night...", "soft", "angry", "raised", "L")
...
label cho_intro_2:
    ...
    call cho_main("She's oot there spreading mean rumours 'bout me!","open","narrow","base","R")
    ...
    call cho_main("{size=-4}When I'm oot o' here I'm going to rip that bitch's head off...{/size}","quiver","narrow","angry","downR")
    g4 "(Yikes!)"
    m "I could hear that."
...
label cho_hermione_talk:
    ...
    call cho_main("Thank ye for getting her off my back, Professor.","base","base","base","mid")
    m "No problem."
