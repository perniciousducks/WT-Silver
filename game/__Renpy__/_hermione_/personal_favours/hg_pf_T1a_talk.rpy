...
label hg_pf_talk:
    ...
    if hg_pf_talk.points == 0: #First time this event taking place.
        her "Ehm... Alright..."
    ...
    if hg_pf_talk.points == 0 and her_whoring <=5:

        $ hg_pf_talk.level = 1 #Event hearts level (0-3)
    ...
    if her_whoring >= 0 and  her_whoring <= 5:
        if her_whoring >= 3 and her_whoring <= 5:
            ...
            $ hg_pf_talk.level = 2 #Event hearts level (0-3)
...
label hg_talk_3:
    ...
    $ hg_pf_talk.level = 3 #Event hearts level (0-3)
