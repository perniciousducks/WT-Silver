...
label hg_pf_grope_breasts:
    ...
    if hg_pf_grope_breasts.points < 1:
        menu:
            "\"(Yes, let's do it!)\"":
                pass
            "\"(Not right now.)\"":
...
label end_hg_breast_molester:
    ...
    $ hg_pf_grope_breasts.points += 1

    # Stats
    $ hg_pf_grope_breasts.counter += 1
