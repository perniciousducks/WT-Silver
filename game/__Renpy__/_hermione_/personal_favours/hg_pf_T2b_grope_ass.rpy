...
label hg_pf_grope_ass:
    ...
    if her_whoring >= 0 and her_whoring <= 5: #[3,4,5]
        ...
        $ hg_pf_grope_ass.level = 1 #Event hearts level (0-3)
        ...
        if hg_pf_grope_ass.points == 0 and her_whoring <= 5: #First time
            ...
            call her_main("This is inappropriate, [genie_name]................","annoyed","angryL",cheeks="blush")
            m "Nobody needs to know how exactly you got the points..."
            call her_main("(These 15 points could really make a difference...)","disgust","down_raised",cheeks="blush")
            call her_main("(Darn it.....!)","angry","worriedCl",cheeks="blush")
        else:
            call her_main("Again.....?","annoyed","angryL",cheeks="blush",ypos="head")
    ...
    #Second Event
        ...
        $ hg_pf_grope_ass.level = 2 #Event hearts level (0-3)
    ...
    #Third Event
        ...
        $ hg_pf_grope_ass.level = 3 #Event hearts level (0-3)
...
label hg_butt_molester_1:
    call blkfade

    hide screen genie

    call her_main("..................","annoyed","angryL",cheeks="blush",ypos="head")
    call her_main("Do you want me to turn around then, [genie_name]?","annoyed","angryL",cheeks="blush")
    ...
    menu:
        ...
        "\"Yes. Turn around, [hermione_name].\"":
            ...
            call her_main("...........................","annoyed","angryL",cheeks="blush")
            call her_main("[genie_name], I would like to be done with this sooner rather then later...","annoyed","angryL",cheeks="blush")
                ...
                "-Give her butt a slap-":
                    ...
                    menu:
                        ...
                        "-Give her butt another slap-":
                            ...
                            call her_main("!!!!!!!!!!!!!","scream","wide",cheeks="blush")
                            call her_main("[genie_name], what are you doing!?","angry","worriedCl",cheeks="blush")
                            call her_main("You said all you were going to do is touch!","angry","worriedCl",cheeks="blush")
                            ...
                            menu:
                                ...
                                "-Give her butt another slap-":
                                    ...
                                    call her_main("Ouch! It hurts!","angry","worriedCl",cheeks="blush")
                                    ...
                                    menu:
                                        g4 "Tsk..."
                                        "\"I... I apologize...\"":
                                            call her_main("Just don't do this anymore, [genie_name]...","annoyed","angryL",cheeks="blush")
                                        ...
                                        "\"You are not getting any points for this!\"":
                                            ...
                                            $ her_mood += 20
                                            $ hg_pf_grope_ass.points += 1

                                            # Stats
                                            $ hg_pf_grope_ass.counter += 1
        ...
        "\"No. Just stand still, [hermione_name].\"":
            ...
            call her_main("[genie_name], please hurry up, before someone discovers us like this...","soft","baseL",cheeks="blush")
            ...
            m "What is it?"
            call her_main("It's nothing, [genie_name]. Your hands are cold, that's all...","open","baseL",cheeks="blush")
            call bld

            call nar(">You run your hands up and down Hermione's legs...")
            call her_main(".........................","annoyed","angryL",cheeks="blush")

            call nar(">You give her buttocks a good squeeze...")
            ...
            menu:
                ...
                "\"Fine. Just keep standing still then.\"":
                    call her_main("Thank you [genie_name]...","angry","worriedCl",cheeks="blush")

                    call nar(">You massage her buttocks lightly...")
                    call her_main("....................","angry","worriedCl",cheeks="blush")

                    call nar(">And keep enjoying the sensation of her ass under your hands...")
                    call her_main(".....................","angry","worriedCl",cheeks="blush")
                ...
                "\"Open your eyes, or lose the points!\"":
                    ...
                    call nar(">You massage her buttocks lightly...","start")
                    call nar(">Hermione maintains the eye contact as she's been told...","end")
                    ...
                    call nar(">You keep on enjoying the sensation of her soft ass-cheeks under your fingertips...")
                    call her_main(".....................","angry","angry")
                    jump connection_of_rapes



label hg_butt_molester_1_continue:
    call ctc
    ...
    call her_main("I can't believe this is really happening...","angry","worriedCl",cheeks="blush")
...
label screams_of_rapings:
    ...
    with hpunch
    call her_main("{size=+7}YOU RAPED ME!{/size}","scream","worriedCl",cheeks="blush",tears="messy")
...
### Second Time Butt Molester ###

label hg_butt_molester_2:
    call blkfade
    ...
    menu:
        ...
        "\"Yes. Turn around, [hermione_name].\"":
            ...
            jump hg_butt_molester_2_continue
...
label hg_butt_molester_2_continue:
    menu:
        "-Slide your hands under her panties-":
            call nar(">You slowly slide one of your hands under the fabric of the girl's panties...")
...
### Third Time Butt Molester ###

label hg_butt_molester_3:
