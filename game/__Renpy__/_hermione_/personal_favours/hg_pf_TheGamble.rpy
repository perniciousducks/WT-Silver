...
label hg_pf_TheGamble_complete:
    ...
    label hg_pf_TheGamble_MySlave:
        ...
        call her_head("N-Nothing. A toy w-wants nothing. It's just used by its owner.","wide_open_tongue","aheagao_mad",cheeks="blush")
        m "VERY good."
        ...
        #her "Yes."215
        call her_head("Yes.","wide_open_tongue","aheagao_mad",cheeks="blush")
        m "How?"
