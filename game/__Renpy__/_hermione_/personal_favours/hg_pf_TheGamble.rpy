...
label hg_pf_TheGamble:
    ...
    call play_music("chipper_doodle") from _call_play_music_233 
    show screen hermione_main
    with d3
    
    m "You know what? I've been doing too much of the work lately."
    call her_main("[genie_name]?","open","base") from _call_her_main_6029#247
    ...
    call her_main("I... then... ahem. What would you like to do then?","open","worriedL") from _call_her_main_6030#249
    m "I am going to sit back and you are going to sit and bounce on my cock."
    call her_main("What?! [genie_name], I don't-","angry","wide") from _call_her_main_6031#250
    m "So Gryffindor doesn't need any points then? Oh, well. I tried. Good day Miss Granger."
    call her_main("Aright, alright. So... what's the pay?","annoyed","frown") from _call_her_main_6032#252
    m "The standard. I have been doing all the work lately. It's only fair."
    
    call play_music("playful_tension") from _call_play_music_234# SEX THEME.
    
    call her_walk(400,325,1.25) from _call_her_walk_120
    ...
    call her_head("...fine. Just let me... there we...","open","angryCl") from _call_her_head_1477#253
    ...
    call her_head("OOOOOOOHH! {image=textheart}","body_235") from _call_her_head_1478#254
    call her_head("Yes...","body_236") from _call_her_head_1479#255
    ...
    call her_head("Ah... ah...{image=textheart}","body_237") from _call_her_head_1480#256
    ...
    m "Go."
    call soft_slaps from _call_soft_slaps
    m "Faster."
    call soft_slaps from _call_soft_slaps_1
    #">You punctuate each word with a slap to her ass."
    call her_head("AAAH! {image=textheart} {image=textheart} {image=textheart}","open_tongue","ahegao_raised",cheeks="blush") from _call_her_head_1481#257
    "She starts to move much faster."
    $ g_c_u_pic = "bounce_ani_f"
    show screen g_c_u
    call her_head("Yes! Harder!","body_232") from _call_her_head_1482#258
    m "Honestly."
    ...
    call hard_slaps from _call_hard_slaps
    call her_head("IT HUUURTS! {image=textheart} {image=textheart}","smile","angry",cheeks="blush") from _call_her_head_1483#259
    m "Even now, I still have to take the initiative, you self-deluding whore!"
    call her_head("I- AH! {image=textheart} I'm n- Ah-a!","body_235") from _call_her_head_1484#260
    m "You're still claiming this is all just for the house points? Even while you're bouncing yourself up and down on my cock? "
    call her_head("I-i-it i-i-i-isss- Ah! {image=textheart}","body_236") from _call_her_head_1485#261
    ...
    call her_head("!!!! REALLY?! (Oh god, I'm getting so close...)","soft","wide") from _call_her_head_1486#262
    ...
    call her_head("Yessss...","body_236") from _call_her_head_1487#263
    m "Answer me clearly, whore! Do we have a deal?"
    call her_head("OH GOD! YES! YES WE HAVE A DEAL!","body_234") from _call_her_head_1488#264
    call her_head("I! I'M-","body_234") from _call_her_head_1489#265
    ...
    call her_head("!!! W-what are you-","shock","wide",cheeks="blush") from _call_her_head_1490#266
    ...
    call her_main("I- N-no! I was just surprised.","angry","worriedCl",cheeks="blush",emote="05") from _call_her_main_6033#267
    m "Oh, and before I forget."
    call cast_spell from _call_cast_spell_7
    ">You cast a spell on Hermione"
    m "There."
    call her_main("What did you just do?","mad","wide",cheeks="blush") from _call_her_main_6034
    ...
    call her_main("I suppose.","annoyed","angryL",cheeks="blush") from _call_her_main_6035#*Looks at you cautiously*
    call her_main("...Thank you.","open","baseL",cheeks="blush") from _call_her_main_6036
    m "You'll need to stop by every morning so I can reapply it."
    call her_main("I-very well. Until then.","disgust","down_raised",cheeks="blush") from _call_her_main_6037
    
    call hermione_exit from _call_hermione_exit
...
label hg_pf_TheGamble_complete:
    ...
    if hg_pf_TheGamble_OBJ.points < 3:
        if hg_pf_TheGamble_OBJ.points == 1:
            ...
            call hermione_enter from _call_hermione_enter
            
            call her_main("","normal","worriedCl") from _call_her_main_6038
            call her_main("G-good morning, [genie_name].","upset","wink") from _call_her_main_6039
            ...
            call her_main("I-no! I mean- its fine.","disgust","narrow") from _call_her_main_6040
            m "...If you say so."
            call cast_spell from _call_cast_spell_8
            ">You cast a spell on Hermione"
            m "There you go. Until next time."
            call her_main("I-yes.","angry","worriedCl",emote="05") from _call_her_main_6041
            $ hg_pf_TheGamble_OBJ.points += 1
            ...
            call hermione_enter from _call_hermione_enter_1
            ...
            with hpunch
            ">Hermione jumps"
            call her_main("I- Oh. Good morning [genie_name]...","grin","dead") from _call_her_main_6042
            ...
            call her_main("I-","base","down") from _call_her_main_6043
            ">her hands keep drifting towards her groin and chests before she jerks and moves them away"
            call her_main("I'm fine.","grin","dead") from _call_her_main_6044
            m "Are you certain?"
            call her_main("I, uh, I need to get to class.","soft","ahegao") from _call_her_main_6045
            m "Very well, then."
            call cast_spell from _call_cast_spell_9
            ">you cast the spell."
            call her_main("","base","down") from _call_her_main_6046
        ...
        call hermione_exit from _call_hermione_exit_1
        $ hermione_takes_classes = True
    ...
    label hg_pf_TheGamble_MySlave:
        ...
        call hermione_enter from _call_hermione_enter_2
        m "Miss Granger?"
        
        call her_walk(400,320,1.25) from _call_her_walk_121
        show screen blkfade
        with fade
        ...
        call play_music("playful_tension") from _call_play_music_235# SEX THEME.
        hide screen hermione_main
        hide screen genie
        ...
        $ h_c_u_pic = "hand_ani"
        call u_pause_ani from _call_u_pause_ani_58
        # show screen h_c_u
        # hide screen g_c_u
        # with d3
        show screen blkfade
        ...
        call her_head("Please- Give- Need- Please!","grin","wink",cheeks="blush") from _call_her_head_1491
        m "So much for a month! You couldn't even last a week!"
        #her "Need- Please-"
        call her_head("Need- Please-","scream","wide",cheeks="blush") from _call_her_head_1492
        ...
        call her_head("AAAAAAAAAAHHH! Biiiiiiig!!!!!","open_tongue","ahegao_raised",cheeks="blush") from _call_her_head_1493
        m "Has your pussy actually gotten tighter?"
        #her "AAAAH! NO! NO! STILL NEEEEED!!!"
        call her_head("AAAAH! NO! NO! STILL NEEEEED!!!","mad","wide",cheeks="blush") from _call_her_head_1494
        m "Oh, right the spell. Well, you'll just have to wait till I'm ready to cum myself."
        #her "!!!"
        call her_head("!!!","mad","angry",cheeks="blush") from _call_her_head_1495
        ">Hermione starts slamming herself against you with abandon."
        $ g_c_u_pic = "sex2_ani"
        show screen g_c_u
        with hpunch
        #her "GIVE! GIVE! GIVE! GIVE! GIVE!"
        call her_head("GIVE! GIVE! GIVE! GIVE! GIVE!","base","ahegao_raised",cheeks="blush") from _call_her_head_1496
        ...
        #her "!!!!"
        call her_head("!!!!","body_234") from _call_her_head_1497
        ...
        #her "Yesss."
        call her_head("Yesss.","disgust","down_raised",cheeks="blush") from _call_her_head_1498
        m "Ready for more?"
        ">Still twitching on the ground, she speaks slowly, as though her thoughts are traveling through molasses."
        #her "I... but... class..."
        call her_head("I... but... class...","shock","wide",cheeks="blush") from _call_her_head_1499
        ...
        #her "Your whore."
        call her_head("Your whore.","grin","wink",cheeks="blush") from _call_her_head_1500
        m "Wrong."
        #her "?"
        call her_head("?","scream","wide",cheeks="blush") from _call_her_head_1501
        ...
        call her_head("I'm your fucktoy.","disgust","down_raised",cheeks="blush") from _call_her_head_1502
        ...
        with kissiris
        #her "MY AAASS!!!"
        call her_head("MY AAASS!!!","open_tongue","ahegao_raised",cheeks="blush") from _call_her_head_1504
        m "Whose ass?"
        ">You lift her off your dick."
        #her "YOURS! YOUR FUCKTOY'S ASS!"
        call her_head("YOURS! YOUR FUCKTOY'S ASS!","soft","dead") from _call_her_head_1505
        ...
        call her_head("MY ASS!!! YOU'LL BREAK IT!!","open_tongue","ahegao_raised",cheeks="blush") from _call_her_head_1508
        ">You lift her up slowly, making the threat clear."
        #her "AHH!! BREAK IT!! BREAK ME!! HARDER!!"
        call her_head("AHH!! BREAK IT!! BREAK ME!! HARDER!!","body_236") from _call_her_head_1509
        call snape_enter from _call_snape_enter
        sna_[1] "What did you-"
        sna_[8] "!!!"
        #her "CUMMING!! MY ASS IS CUMMING!!"
        call her_head("CUMMING!! MY ASS IS CUMMING!!","body_236") from _call_her_head_1510
        ...
        #her "AAAAH! OH GOD!"
        call her_head("AAAAH! OH GOD!","body_238") from _call_her_head_1511
        sna_[18] "Ha! Of course!"
        #her "AGAIN!! CUMMING AGAIN!! {image=textheart} {image=textheart}"
        call her_head("AGAIN!! CUMMING AGAIN!! {image=textheart} {image=textheart}","body_237") from _call_her_head_1512
        sna_[21] "(This might be the happiest day of my life!)"
        call snape_leave from _call_snape_leave
        ...
        call her_head("I'm going insane! Your dick is driving your fucktoy insane!","body_236") from _call_her_head_1513
        m "You and your way with words!"
        #her "CUMMING! STILL CUMMING!"
        call her_head("CUMMING! STILL CUMMING!","body_234") from _call_her_head_1514
        ...
        #her "MY ASS! SO HOT!"
        call her_head("MY ASS! SO HOT!","body_235") from _call_her_head_1515
        #her "FILLING MY ASS!"
        call her_head("FILLING MY ASS!","body_236") from _call_her_head_1516
        m "YOU LIKE IT?"
        #her "YES!!!! {image=textheart} {image=textheart}"
        call her_head("YES!!!! {image=textheart} {image=textheart}","body_234") from _call_her_head_1517
        m "HAVE SOME MORE!"
