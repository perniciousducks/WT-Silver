...
label hg_pf_TouchYourself: #LV.4 (Whoring = 8 - 10)
    ...
    if hg_pf_TouchYourself_OBJ.points == 0:
        ...
        if hg_pf_TouchYourself_OBJ.points == 0: #HERMIONE DOESN'T CUM
            ...
            call her_main("yes [genie_name], ah...{image=textheart}","grin","ahegao_angry",cheeks="blush")
            ...
            call her_main("{image=textheart}{image=textheart}{image=textheart}!!!{image=textheart}{image=textheart}{image=textheart}","body_133b")
    ...
    #Third time event.
        ...
        menu:
            ...
            "\"Play with your tits some more!\"":
                ...
                call her_main("Mmmm...","grin","ahegao_angry",cheeks="blush")
                m "That's it..."
        ...
        menu:
            ...
            "-Grab her tits-":
                ...
                call her_main("Ah... while you play with me...{image=textheart}","grin","ahegao_angry",cheeks="blush")
                m "Heh... Nice."
                ...
                call her_main("Ah...{image=textheart} {size=+5}please finger my cunt!{/size}","grin","ahegao_angry",cheeks="blush")
        ...
        call her_main("I'm cumming from being fucked with your fingers!!{image=textheart}{image=textheart}","grin","ahegao_angry",cheeks="blush")
