...
label hg_pr_handjob: #LV.6 (Whoring = 15 - 17)
    ...
    #Second time event.
        ...
        #Third level.
            ...
            call her_main("I don't mind, [genie_name].","annoyed","down",xpos="right",ypos="base")
            m "Really?"
...
label hg_pr_handjob_complete:
    ...
    if her_whoring >= 15 and her_whoring < 18:
        ...
        if one_out_of_three == 1:
            ...
            show screen blktone
            call play_music("chipper_doodle") # HERMIONE'S THEME.
            call her_main("Quite awful... of course...","annoyed","frown",xpos="right",ypos="base")
            ...
            menu:
                "\"Well, this doesn't count then.\"":
                    ...
                    call her_main("What?","angry","wide",xpos="right",ypos="base")
                ...
                "\"You shall only get half the payment then.\"":
                    ...
                    call her_main("Oh...?","open","base",xpos="right",ypos="base")
                ...
                "\"Well, you did try. Here are the points.\"":
                    call her_main("Really?","angry","base",xpos="right",ypos="base")
