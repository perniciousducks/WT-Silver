...
label costume_scene_1: #Maid role-play
    call her_main("A costume? What on earth do you need me to dress up for?","angry","wide") from _call_her_main_918
    m "[hermione_name], have you ever heard of the term role-play?"
    call her_main("role-play?","smile","glance") from _call_her_main_919
    m "It's where you pretend to be someone you're not."
    call her_main("I gathered that much but why would I want to do that?","smile","glance") from _call_her_main_920
    m "Because it can be fun!"
    call her_main("Hmmmm. Who would I be role-playing?","smile","glance") from _call_her_main_921
    ...
    if whoring < 17:
        call her_main("And how much would this \"personal maid\" be paid?","smile","glance") from _call_her_main_922
        m "35 points sounds fair."
    call her_main("...","smile","glance") from _call_her_main_923
    call her_main("Let me go change.","smile","glance") from _call_her_main_924
    $ stockings = 1
    $ custom_outfit_old = 1
    call her_main("","smile","glance") from _call_her_main_925
    pause
    call her_main("Well?","smile","glance") from _call_her_main_926
    m "You certainly look the part. The question is can you act the part?"
    call her_main("Act? I thought you just wanted me to clean your room?","smile","glance") from _call_her_main_927
    m "Where's the fun in that? If I wanted a clean room, I'd just get those ugly dwarves to do it."
    call her_main("House elfs.","smile","glance") from _call_her_main_928
    m "Whatever. Anyway I want you to act like a sexy french maid."
    her "Why does it have to be french?"
    m "Must I explain everything?"
    call her_main("Fine...","smile","glance") from _call_her_main_929
    call her_main("Is there anything you need cleaned today sir?","smile","glance") from _call_her_main_930
    m "At least try to do the accent."
    call her_main("...","smile","glance") from _call_her_main_931
    call her_main("Is there anything that you need cleaned today Monsieur?","mad","angry",cheeks="blush") from _call_her_main_932
    m "Much better."
    call her_main("Thank you Monsieur.","smile","glance") from _call_her_main_933
    m "Now as for your cleaning I think that the fireplace could you a good dusting."
    call her_main("As you command Monsieur!","smile","glance") from _call_her_main_934
