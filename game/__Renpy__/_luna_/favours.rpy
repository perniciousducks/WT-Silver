...
label luna_favour_7:
    m "Luna."
    call luna_main("yes sir...", 1, 1, 4, 1) 
    m "Today I have a new type of favour for you."
    call luna_main("really?", 4, 1, 1, 1) 
    m "Today, we'll be-"
    call luna_main("Wait!", 4, 1, 2, 1) 
    call luna_main("Before you ask me...", 5, 2, 4, 1) 
    call luna_main("can you please summon Hermione?", 5, 1, 4, 2) 
    m "You don't even know what I'm going to ask you yet!"
    call luna_main("I have a fair idea sir...", 7, 1, 2, 1) 
    call luna_main("And if it's alright with you, I'd prefer that Hermione be here as well.", 5, 2, 4, 1) 
    m "well I'm not going to say no to that!"
    call luna_main("Thank you sir...", 2, 1, 4, 1) 
    ">You summon Hermione up to your office."
    $ luna_xpos = 300
    $ luna_flip = -1
    ...
    call luna_main("He hasn't even asked yet.", 5, 2, 4, 1) 
    call luna_main("I wanted you to be here for it.", 6, 8, 4, 1) 
    ...
    call luna_main("You really don't need to worry about it [l_genie_name]...", 1, 3, 4, 2) 
    ...
    call luna_main("I...", 4, 2, 4, 1) 
    call luna_main("I......", 4, 2, 4, 2) 
    call luna_main("I can't!", 4, 3, 4, 3) 
    ...
    call luna_main("I know...", 1, 2, 3, 4) 
    call luna_main("It's just...", 1, 3, 4, 14) 
    call luna_main("I don't think I can handle it...", 1, 2, 4, 3) 
    call luna_main("I'm not like you... I can't be good at everything...", 3, 2, 4, 15) 
    show screen blkfade
    "*SLAP*"
    ...
    call luna_main("but I'm not as-", 1, 2, 4, 4) 
