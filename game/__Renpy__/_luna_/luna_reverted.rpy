...
label luna_reverted_event_5: #Luna regular BJ for about 5 hours with Luna masturbating the whole time #NEEDS POSING
    ...
    menu:
        ...
        "Shoot it down her throat":
            $ lunCG('dick', pos=8)
            g9 "Ugh... You are just too good at this..."
            $ lunCG(pos=10)
