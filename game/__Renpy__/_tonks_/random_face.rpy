...
label set_ton_face(change=None, mouth=None, eyes=None, eyebrows=None, pupils=None, hair=None):
    ...
    if hair != None:
        ...
        if hair in ("angry"):
            ...
            $ target_color = [[64, 75, 205, 255]] # blue
    ...
    python:
        tonks.set_face(mouth=temp_mouth, eyes=temp_eyes, eyebrows=temp_eyebrows, pupils=temp_pupils, cheeks=temp_cheeks, tears=temp_tears)
