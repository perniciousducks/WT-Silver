...
label __init_variables:
    python:
        ...
        card_width = get_width("images/cardgame/final_not_final.png")
        card_height = get_height("images/cardgame/final_not_final.png")
        
        playerboarder = playerTint("images/cardgame/sides.png")
        enemyboarder = enemyTint("images/cardgame/sides.png")
        
        card_test = card_new(       imagepath="images/cardgame/final_not_final.png",
                                    topvalue = 2,
                                    buttomvalue = 3,
                                    rightvalue = 3,
                                    leftvalue = 1,
        ...
        unlocked_cards = [card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone()]
        ...
        playerdeck = [card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone()]
        
        #if not hasattr(renpy.store,'snape_first_deck'):
        snape_first_deck = [card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone()]
        snape_second_deck = [card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone()]
        snape_third_deck = [card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone(), card_test.clone()]
...
init python:
    ...
    class card_new(object):
        ...
        def clone(self):
            return card_new(title = self.title,imagepath=self.imagepath, topvalue=self.topvalue, buttomvalue=self.buttomvalue, rightvalue=self.rightvalue, leftvalue=self.leftvalue)
