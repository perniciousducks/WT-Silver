...
label __init_variables:
    python:
        ...
        snape_first_deck = [normalcl.clone(), h_cheer_com.clone(), genieforest.clone(), nightdressbreast.clone(), snapeandelf.clone()]
        snape_second_deck = [normalcl.clone(), h_cheer_com.clone(), genieforest.clone(), nightdressbreast.clone(), snapeandelf.clone()]
        snape_third_deck = [normalcl.clone(), h_cheer_com.clone(), genieforest.clone(), nightdressbreast.clone(), snapeandelf.clone()]
