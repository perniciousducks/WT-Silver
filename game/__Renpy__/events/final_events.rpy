...
label giving_the_dress:
    $ her_dress_wearable = True #Unlocks the dress in the wardrobe. Makes it wearable.
    #$ gave_the_dress = True # Removed. Starts in "label start_end_events" now.
    $ days_without_an_event = 0
