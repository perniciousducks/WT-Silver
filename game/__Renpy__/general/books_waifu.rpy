...
label waifu:
    ...
    if Dear_Wifu_OBJ.progress < 20:
        ...
        call school_ended from _call_school_ended
            ...
            menu:
                ...
                "-Hang around the library (page 97)-":
                    ...
                    if leena >= 4:
                        ...
                        call epilogue from _call_epilogue_4
                        return
                    if leena < 4: 
                        ...
                        call epilogue from _call_epilogue_5
                        return
    return
