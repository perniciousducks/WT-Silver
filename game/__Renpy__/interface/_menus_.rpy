...
screen wardorobe_menu(character, category, toggle, xpos, ypos):
    $ ui_xpos = xpos
    $ ui_ypos = ypos
    ...
    imagemap:
        ...
        #for i in range(0,3): # Left side.
        #    if category == wardrobe_categories[i]:
        #        hotspot (ui_xpos +nxpos , ui_ypos +nypos +(110*i) , 86 , 93) clicked SetVariable("category_choice",None), Return("pause")
        #    else:
        #        hotspot (ui_xpos +nxpos , ui_ypos +nypos +(110*i) , 86 , 93) clicked SetVariable("category_choice",wardrobe_categories[i]), Return("pause")

        #for i in range(4,7): # Right side.
        #    if category == wardrobe_categories[i]:
        #        hotspot (ui_xpos +nxpos +426 , ui_ypos +nypos +(110*(i-4)) , 86 , 93) clicked SetVariable("category_choice",None), Return()
        #    else:
        #        hotspot (ui_xpos +nxpos +426 , ui_ypos +nypos +(110*(i-4)) , 86 , 93) clicked SetVariable("category_choice",wardrobe_categories[i]), Return()

        if category == "head":
            hotspot (ui_xpos +nxpos , ui_ypos +nypos, 86, 93) clicked SetVariable("current_category",None), Return("pause")
        else:
            hotspot (ui_xpos +nxpos +48, ui_ypos +nypos, 38, 93) clicked SetVariable("current_category","head"), Return("pause")

        #Tops
        if category == "tops":
            hotspot (ui_xpos +nxpos , ui_ypos +nypos+(110*1), 86, 93) clicked SetVariable("current_category",None), Return("pause")
        else:
            hotspot (ui_xpos +nxpos +48, ui_ypos +nypos+(110*1), 38, 93) clicked SetVariable("current_category","tops"), Return("pause")

        #Bottoms
        if category == "bottoms":
            hotspot (ui_xpos +nxpos , ui_ypos +nypos+(110*2), 86, 93) clicked SetVariable("current_category",None), Return("pause")
        else:
            hotspot (ui_xpos +nxpos +48, ui_ypos +nypos+(110*2), 38, 93) clicked SetVariable("current_category","bottoms"), Return("pause")

        #Other Clothings
        if category == "other":
            hotspot (ui_xpos +nxpos, ui_ypos +nypos+(110*3), 86, 93) clicked SetVariable("current_category",None), Return("pause")
        else:
            hotspot (ui_xpos +nxpos +48, ui_ypos +nypos+(110*4), 38, 93) clicked SetVariable("current_category","other"), Return("pause")
