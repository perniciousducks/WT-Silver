...
screen top_bar_close_button(offsetx = 0, offsety = 0, close_var=lambda : "Close", flip=-1):
    add "interface/topbar/buttons/"+interface_color+"/ui_edge_empty.png" xpos 1045-offsetx xalign 0.0 ypos offsety xzoom flip
    imagebutton:
            xpos 1043-offsetx
            ypos -2 -offsety
            idle "interface/general/button_close.png"
            hover "interface/general/button_close_hover.png"
...
screen ui_top_bar():
    ...
    if not renpy.get_screen("clothing_store_room") and not renpy.get_screen("weasley_store_room"):
        # Menu button
        add "interface/topbar/buttons/"+interface_color+"/ui_edge_empty.png" xpos 0 ypos 0
        imagebutton:
            xpos -3
            ypos -5
            idle "interface/topbar/buttons/ui_menu.png"
            if renpy.get_screen("main_room_menu"):
                hover image_hover("interface/topbar/buttons/ui_menu.png")
        ...
        # Stats button
        if day != 1:
            add "interface/topbar/buttons/"+interface_color+"/ui_button_empty.png" xpos 943 ypos 0
            imagebutton:
                xpos 943
                idle "interface/topbar/buttons/ui_stats.png"
                if renpy.get_screen("main_room_menu"):
                    hover image_hover("interface/topbar/buttons/ui_stats.png")
        ...
        # Inventory button
        if day != 1:
            add "interface/topbar/buttons/"+interface_color+"/ui_button_empty.png" xpos 976 ypos 0
            imagebutton:
                xpos 976
                idle "interface/topbar/buttons/ui_inv.png"
                if renpy.get_screen("main_room_menu"):
                    hover image_hover("interface/topbar/buttons/ui_inv.png")
        ...
        if letter_paperwork_unlock_OBJ.read:
            add "interface/topbar/buttons/"+interface_color+"/ui_button_empty.png" xpos 1009 ypos 0
            imagebutton:
                xpos 1009
                idle "interface/topbar/buttons/ui_work.png"
                if renpy.get_screen("main_room_menu"):
                    hover image_hover("interface/topbar/buttons/ui_work.png")
        ...
        # Sleep button
        add "interface/topbar/buttons/"+interface_color+"/ui_edge_empty.png" xpos 1045 xalign 0.0 ypos 0 xzoom -1
        if day != 1:
            imagebutton:
                xpos 1050
                ypos -3
                idle "interface/topbar/buttons/ui_sleep.png"
                if renpy.get_screen("main_room_menu"):
                    hover image_hover("interface/topbar/buttons/ui_sleep.png")
                    if daytime:
