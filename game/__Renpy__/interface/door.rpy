                ...
                if not door_dict[char]["flag"]:
                    ...
                    if not door_show_busy and door_dict[char]["busy"]:
                        ...
                        frame:
                            ...
                            if not door_dict[char]["busy"]:
                                $ image_zoom = crop_image_zoom("interface/icons/head/"+stats_dict.get(char).get("ico")+".png", 42, 42)
                            else:
                                $ image_zoom = crop_image_zoom("interface/icons/head/"+stats_dict.get(char).get("ico")+".png", 42, 42, True)
                            frame:
                                style "empty"
                                xsize 42
                                ysize 42
