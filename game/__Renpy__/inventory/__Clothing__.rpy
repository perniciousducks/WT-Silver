...
label update_outfit_layers:
    ...
    $ hg_witch_ITEM.outfit_layers = ["../robe/witch_cloak_back.png","../stockings/stockings_witch_1.png","../onepieces/witch_top_1.png","../robe/witch_cloak.png"]
    $ hg_witch_ITEM.breast_layer  = "breasts_normal"
    $ hg_witch_ITEM.top_layers    = "hat_witch"

    $ hg_witch_skimpy_ITEM.outfit_layers = ["../robe/witch_cloak_back.png","../stockings/stockings_witch_1.png","../onepieces/witch_top_2.png","../robe/witch_cloak.png"]
    ...
    $ hg_costume_lara_croft_ITEM.outfit_layers = ["../bottoms/base/pants_raider.png","../tops/base/top_raider.png","../gloves/gloves_leather_2.png"]
