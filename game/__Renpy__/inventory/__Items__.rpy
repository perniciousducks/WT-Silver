...
label store_items_init:
    ...
    if not hasattr(renpy.store,'cc_lingerie_lace_ITEM'):
        $ cc_lingerie_lace_ITEM  = item_class(id="cc_lingerie_lace", name="Lace Lingerie", type="set", items=["bra","panties","garter","stockings","choker","earrings"], image="outfits/cc_lingerie_lace", cost=500, wait_time=5, description=">This lingerie set turns even the toughest tomboy into a cute princess!")
