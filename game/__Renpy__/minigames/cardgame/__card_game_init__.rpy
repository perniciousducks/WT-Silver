label __init_variables:
    python:
        ...
        empty = card_new( imagepath="images/cardgame/border.png",
                                    topvalue = 0,
                                    bottomvalue = 0,
                                    rightvalue = 0,
                                    leftvalue = 0,
        ...
        jasmine = card_new( imagepath="images/cardgame/t1/genie_realm/jas_v%s.png" % str(geniecard_level),
                                    topvalue = 2,
                                    bottomvalue = 3,
                                    rightvalue = 2,
                                    leftvalue = 4,
        ...
        iris = card_new( imagepath="images/cardgame/t1/genie_realm/iri_v%s.png" % str(geniecard_level),
                                    topvalue = 3,
                                    bottomvalue = 2,
                                    rightvalue = 4,
                                    leftvalue = 2,
        ...
        azalea = card_new( imagepath="images/cardgame/t1/genie_realm/azalea_v%s.png" % str(geniecard_level),
                                    topvalue = 4,
                                    bottomvalue = 2,
                                    rightvalue = 2,
                                    leftvalue = 3,
        ...
        dahlia = card_new( imagepath="images/cardgame/t1/genie_realm/dahlia_v1.png",
                                    topvalue = 3,
                                    bottomvalue = 3,
                                    rightvalue = 1,
                                    leftvalue = 2,
        ...
        aladdin = card_new( imagepath="images/cardgame/t1/genie_realm/aladdin_v1.png",
                                    topvalue = 4,
                                    bottomvalue = 2,
                                    rightvalue = 1,
                                    leftvalue = 4,
        ...
        lilly = card_new( imagepath="images/cardgame/t1/genie_realm/lilly_v1.png",
                                    topvalue = 1,
                                    bottomvalue = 5,
                                    rightvalue = 5,
                                    leftvalue = 5,
        ...
        maslab = card_new( imagepath="images/cardgame/t1/genie_realm/maslab_v1.png",
                                    topvalue = 2,
                                    bottomvalue = 3,
                                    rightvalue = 4,
                                    leftvalue = 4,
        ...
        rasul = card_new( imagepath="images/cardgame/t1/genie_realm/rasul_v1.png",
                                    topvalue = 6,
                                    bottomvalue = 2,
                                    rightvalue = 2,
                                    leftvalue = 2,
        ...
        jafar = card_new( imagepath="images/cardgame/t1/genie_realm/jafar_v1.png",
                                    topvalue = 4,
                                    bottomvalue = 1,
                                    rightvalue = 4,
                                    leftvalue = 2,
        ...
        if not hasattr(renpy.store,'unlocked_cards'):
            ...
            card_rand_girl = renpy.random.choice([her_schoolgirl, sus_schoolgirl, cho_schoolgirl, lun_schoolgirl])
            card_rand_item1 = renpy.random.choice([item_desk, item_bird])
            card_rand_item2 = renpy.random.choice([item_beads, item_dildo, item_doll, item_condoms, item_plugs])
            card_rand_item3 = renpy.random.choice([item_barbell, item_lingerie, item_stockings, item_badge, item_bdsm, item_lipstick])
            card_rand_item4 = renpy.random.choice([item_bookchairs, item_bookgala, item_bookgala2, item_bookwaifu, item_hat])
        ...
        if not hasattr(renpy.store,'snape_first_deck'):
            ...
            snape_second_deck = [snape.clone(), item_potions.clone(), item_elf.clone(), item_elf.clone(), item_eromag.clone()]
