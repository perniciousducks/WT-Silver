...
label equip_gryyf_stockings:
    ...
    if wardrobe_events_active: #NOT IN USE
        ...
        if whoring < 3:
            ...
            call her_main("...") 
            call her_main("hhmppphhh","full","ahegao_intense") 
            ...
            call her_main("I NEED THEM!","angry","worriedCl",emote="05") 
            call her_main("What'll it cost me!?","angry","worriedCl",emote="05") 
            ...
            m "Easy, right?"
            call her_main("...") 
            call her_main("You just want to see me in stockings? That should be no problem...","open","base") 
            ...
            call her_main("I'm just showing that bastard a little square of fabric","open","annoyed",cheeks="blush") 
            ...
            call her_main("(it won't work on someone like me...)","open","worriedCl",cheeks="blush") 
            m "Your panties, your stockings... they make you look so pretty"
            call her_main("(ahh! he called me pretty)","base","baseL",cheeks="blush") 
            ...
            menu:
                ...
                "Cute is boring. Break her.":
                    ...
                    call her_main("NO","scream","angry",cheeks="blush",emote="01") 
                    g4 "(?)"
