...
init:
    $ cho_top_school_CLOTH = cloth_class(char="cho", type="top", id="top_school1", layers=5, name="School top", desc="description")
...
init -5 python:
    class cloth_class(object):
        ...
        def get_imagelayer(self, layer):
            return self.imagepath+str(self.id)+"_"+str(layer)+".png"
