...
label equip_her_bra:
    call set_h_bra(underwear_choice, underwear_color_choice) from _call_set_h_bra
...
label equip_ast_bra:
    ...
    #    jump equipping_failed
        ...
        call set_ast_bra(underwear_choice) from _call_set_ast_bra
        
        call ast_main(xpos="wardrobe") from _call_ast_main_526
        call screen wardrobe
        
### Equip Susan's Bra ###
label equip_sus_bra:
    call set_sus_bra(underwear_choice) from _call_set_sus_bra
...
label equip_her_onepiece:
    call set_h_onepiece(underwear_choice) from _call_set_h_onepiece
...
label equip_ast_onepiece:
    call set_ast_onepiece(underwear_choice) from _call_set_ast_onepiece
...
label equip_sus_onepiece:
    call set_sus_onepiece(underwear_choice) from _call_set_sus_onepiece
...
label equip_her_panties:
    call set_h_panties(underwear_choice, underwear_color_choice) from _call_set_h_panties
...
label equip_ast_panties:
    ...
    #    jump equipping_failed
        ...
        call set_ast_panties(underwear_choice) from _call_set_ast_panties
        
        call ast_main(xpos="wardrobe") from _call_ast_main_527
        call screen wardrobe
        
### Equip Susan's Panties ###
label equip_sus_panties:
    call set_sus_panties(underwear_choice) from _call_set_sus_panties
...
label equip_her_garterbelt:
    call set_h_garterbelt(underwear_choice, underwear_color_choice) from _call_set_h_garterbelt
...
label equip_ast_garterbelt:
    call set_ast_garterbelt(underwear_choice, underwear_color_choice) from _call_set_ast_garterbelt
...
label equip_sus_garterbelt:
    call set_sus_garterbelt(underwear_choice, underwear_color_choice) from _call_set_sus_garterbelt
