label __init_variables:
    python:
        if not hasattr(renpy.store,'cho_class') or reset_persistants:
            ...
            #
            #
            cho_cloth_schoolskirt2 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_2", layers=2, color=[[82, 69, 87, 255], color_black])
            cho_cloth_schoolskirt3 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_3", layers=2, color=[[82, 69, 87, 255], color_black])
            cho_cloth_schoolskirt4 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_4", layers=2, color=[[82, 69, 87, 255], color_black])
