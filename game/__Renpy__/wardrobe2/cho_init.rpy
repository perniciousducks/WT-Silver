label __init_variables:
    python:
        if not hasattr(renpy.store,'cho_class') or reset_persistants:
            ...
            cho_cloth_topschool4 = cloth_class(char="cho", category="tops", subcat="school", type="top", id="top_school_4", layers=5, color=[[183, 183, 184, 255], [216, 163, 10, 255], [89, 116, 194, 255], color_black])
            cho_cloth_topschool5 = cloth_class(char="cho", category="tops", subcat="school", type="top", id="top_school_5", layers=4, color=[[183, 183, 184, 255], [216, 163, 10, 255], [89, 116, 194, 255], color_black])
            cho_cloth_topshirt1 = cloth_class(char="cho", category="tops", subcat="muggle", type="top", id="top_shirt_1", layers=2, color=[[255, 229, 126, 255], color_black])
            cho_cloth_topsailor1 = cloth_class(char="cho", category="tops", subcat="muggle", type="top", id="top_sailor_1", layers=3, color=[[252, 252, 253, 255], [89, 116, 194, 255], color_black])
            cho_cloth_topsweater1 = cloth_class(char="cho", category="tops", subcat="quidditch", type="top", id="top_sweater_1", layers=3, color=[[20, 29, 83, 255], [213, 161, 13, 255], color_black])
            cho_cloth_topsweater2 = cloth_class(char="cho", category="tops", subcat="quidditch", type="top", id="top_sweater_2", layers=3, color=[[20, 29, 83, 255], [213, 161, 13, 255], color_black])
            cho_cloth_toptanktop1 = cloth_class(char="cho", category="tops", subcat="muggle", type="top", id="top_tanktop_1", layers=2, color=[[230, 230, 231, 255], color_black])
            cho_cloth_toptanktop2 = cloth_class(char="cho", category="tops", subcat="muggle", type="top", id="top_tanktop_2", layers=3, color=[[252, 192, 213, 255], [253, 221, 232, 255], color_black])

            # Bottoms
            cho_cloth_schoolskirt1 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_1", layers=5, color=[[86, 74, 91, 255], [98, 87, 103, 255], [109, 98, 115, 255], [232, 177, 13, 255], color_black])
            cho_cloth_schoolskirt2 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_2", layers=5, color=[[86, 74, 91, 255], [98, 87, 103, 255], [109, 98, 115, 255], [232, 177, 13, 255], color_black])
            cho_cloth_schoolskirt3 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_3", layers=5, color=[[86, 74, 91, 255], [98, 87, 103, 255], [109, 98, 115, 255], [232, 177, 13, 255], color_black])
            cho_cloth_schoolskirt4 = cloth_class(char="cho", category="bottoms", subcat="school", type="bottom", id="school_skirt_4", layers=5, color=[[86, 74, 91, 255], [98, 87, 103, 255], [109, 98, 115, 255], [232, 177, 13, 255], color_black])
            cho_cloth_pantslong1 = cloth_class(char="cho", category="bottoms", subcat="muggle", type="bottom", id="pants_long_1", layers=2, color=[[230, 230, 231, 255], color_black])
            cho_cloth_pantsshort1 = cloth_class(char="cho", category="bottoms", subcat="muggle", type="bottom", id="pants_short_1", layers=2, color=[[230, 230, 231, 255], color_black])
            ...
            # Panties
            cho_cloth_basicpanties1 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="basic_panties_1", layers=4, color=[[230, 230, 231, 255], [220, 220, 221, 255], [173, 23, 48, 255], color_black])
            cho_cloth_basicpanties2 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="basic_panties_2", layers=3, color=[[230, 230, 231, 255], [220, 220, 221, 255], color_black])
            cho_cloth_bikinibottom1 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="bikini_bottom_1", layers=2, color=[[213, 161, 13, 255], color_black])
            cho_cloth_bikinibottom2 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="bikini_bottom_2", layers=2, color=[[213, 161, 13, 255], color_black])
            cho_cloth_lacepanties1 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="lace_panties_1", layers=5, color=[[230, 230, 231, 255], [187, 192, 255, 255], [230, 230, 231, 255], [81, 84, 184, 255], color_black])
            cho_cloth_lacepanties2 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="lace_panties_2", layers=4, color=[[230, 230, 231, 255], [187, 192, 255, 255], [230, 230, 231, 255], color_black])
            cho_cloth_sportpanties1 = cloth_class(char="cho", category="underwear", subcat="panties", type="panties", id="sport_panties_1", layers=3, color=[[156, 204, 249, 255], [211, 234, 250, 255], color_black])
            ...
            # Hair
            cho_hair_ponytail = cloth_class(char="cho", category="head", subcat="hair", type="hair", id="ponytail", layers=4, color=[[43, 42, 51, 255], [54, 62, 95, 255], [80, 102, 164, 255], color_black])
            ...
            cho_cloth_fishnet_stockings_1 = cloth_class(char="cho", category="legs", subcat="stockings", type="stockings", id="fishnet", layers=4, color=[[50, 50, 51, 255], [50, 50, 51, 255], [50, 50, 51, 255], color_black])
            # Garterbelts
