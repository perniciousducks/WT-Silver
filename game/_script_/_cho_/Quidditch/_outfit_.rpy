...
label use_quidditch_skirt_1:
    ...
    if "skirt_1" not in quid_outfit_intro:
        ...
        call cho_main("So that's your plan then? For me to distract \'the enemy\' with some upskirt?", "pout", "narrow", "angry", "mid")
        ...
        call cho_main("But I can't go and play a game with a skirt on!", "horny", "wide", "worried", "down")
        call cho_main("All my friends would see!", "annoyed", "wide", "worried", "mid")
        ...
        call cho_main("You... might be right...", "open", "base", "worried", "downR")
...
label remove_quidditch_coat:
    ...
    if cho_tier < 2: # Hasn't won against Hufflepuff yet.
        ...
        call cho_main("Fine...", "pout", "narrow", "angry", "R")
