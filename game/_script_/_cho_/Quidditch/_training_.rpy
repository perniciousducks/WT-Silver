...
label cho_quid_E1:
    ...
    menu:
        "\"It's all about the ass!\"":
            ...
            m "Yours, of course."
            call cho_main("M-my... my ass?", "open", "wide", "raised", "mid", cheeks="blush")
...
label cho_quid_E2:
    ...
    call cho_main("But I've simply run out of options.{p}If we want to win the cup this year, you're the only hope we have left...", "open", "narrow", "angry", "mid")
    ...
    if cho_quid.position == "front":
        ...
        call cho_main("(...)", "annoyed", "narrow", "angry", "mid")
        call cho_main("I'm not here to deny that my behind is in great shape.{p}And I'm very proud of it!", "open", "closed", "base", "mid")
        g9 "You should be!"
    ...
    if cho_chibi.action == "fly":
        ...
        menu:
            ...
            "-Change Tactic-" if not cho_quid.lock_tactic:
                ...
                call cho_main("Yes, Sir!", "open", "closed", "angry", "mid", xpos="base", ypos="head")
                hide screen bld1
                with d3
                pause .2
...
label demonstrate_tactic(position=""):
    ...
    # The ~Panties~ position!
        ...
        if cho_quid.bottom in ["skirt_short", "skirt_long"]:
            call cho_main("But then you could see under my skirt, [cho_genie_name]!", "open", "base", "base", "downR", xpos="base", ypos="head")
            g4 "Which is what we are going for, [cho_name]!"
            g4 "Maximum distraction!{w} Now show me those panties!"
            call cho_main("(...)", "annoyed", "narrow", "angry", "downR", xpos="base", ypos="head")
        else:
        ...
        if cho_quid.bottom in ["skirt_short", "skirt_long"]:
            ...
            call cho_main("*Uhm*...{w} Thank you, [cho_genie_name].", "annoyed", "base", "base", "down", xpos="base", ypos="head")
