...
label hufflepuff_match:
    ...
    call cho_main("Hey, Granger!", "open", "angry", "narrow", "L", ypos=-200, xpos=560)
    ...
    call cho_main("The game is over, you dipstick!", "scream", "angry", "narrow", "L")
    call cho_main("", "annoyed", "narrow", "raised", "L")
    call her_main("What? Already?", "shock", "wide", "worried", "stare")
    call cho_main("", "upset", "angry", "narrow", "L")
    call her_main("But who caught the Snitch?", "open", "wide", "base", "stare")
    call cho_main("", "open", "angry", "narrow", "L")
    ...
    call cho_main("My first ever win this season and you didn’t even notice it! No one did, thanks to your dreadful commentating!", "scream", "closed", "narrow", "L")
    call cho_main("", "upset", "angry", "narrow", "down")
    ...
    call cho_main("{size=+10}YES!{/size}", "scream", "angry", "narrow", "L", trans=vpunch)
    call her_main("", "normal", "base", "worried", "mid")
    ...
    call cho_main("", "angry", "wide", "narrow", "L")
    call her_main("", "normal", "base", "angry", "mid")
    call cho_main("{size=+6}WHAT DID YOU JUST CALL ME?!!!{/size}", "scream", "wide", "narrow", "L", trans=vpunch)
    call cho_main("", "angry", "wide", "narrow", "L")
    ...
    call cho_main("{size=+6}You are done, Granger!{/size}", "scream", "closed", "narrow", "L")
