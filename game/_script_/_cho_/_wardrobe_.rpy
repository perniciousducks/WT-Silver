...
default cho_top_j_school1 = DollCloth("cho", ("tops", "shirts"), "top", "top_j_school_1", [[255, 248, 223, 255], [95, 110, 142, 255], [161, 161, 164, 255], [253, 254, 250, 255]], level=1, armfix=True)
default cho_bottom_j_skirt1 = DollCloth("cho", ("bottoms", "skirts"), "bottom", "j_school_skirt_1", [[161, 161, 164, 255]], level=1, armfix=True)
default cho_stockings_j_kneehigh1 = DollCloth("cho", ("legwear", "socks"), "stockings", "kneehigh", [[253, 254, 250, 255]], level=1)
