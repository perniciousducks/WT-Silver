...
default cho_top_school1 = DollCloth("cho", ("tops", "school"), "top", "top_school_1", [[183, 183, 184, 255], [109, 105, 121, 255], [216, 163, 10, 255], [89, 116, 194, 255]], unlocked=True)
default cho_top_school2 = DollCloth("cho", ("tops", "school"), "top", "top_school_2", [[183, 183, 184, 255], [109, 105, 121, 255], [216, 163, 10, 255], [89, 116, 194, 255]], level=4, unlocked=True)
default cho_top_school3 = DollCloth("cho", ("tops", "school"), "top", "top_school_3", [[183, 183, 184, 255], [216, 163, 10, 255], [89, 116, 194, 255]], level=8, unlocked=True)
default cho_top_school4 = DollCloth("cho", ("tops", "school"), "top", "top_school_4", [[183, 183, 184, 255], [216, 163, 10, 255], [89, 116, 194, 255]], level=8, unlocked=True)
default cho_top_school5 = DollCloth("cho", ("tops", "school"), "top", "top_school_5", [[183, 183, 184, 255], [216, 163, 10, 255], [89, 116, 194, 255]], level=12, unlocked=True)
default cho_top_school6 = DollCloth("cho", ("tops", "school"), "top", "top_school_6", [[109, 105, 121, 255], [216, 163, 10, 255], [89, 116, 194, 255]], level=12, unlocked=True)
...
default cho_stockings_house = DollCloth("cho", ("legwear", "stockings"), "stockings", "house", [[216, 163, 10, 255], [89, 116, 194, 255]], unlocked=True)
...
, cho_top_tank2, cho_stockings_pantyhose, cho_earring_basic], price=500)
...
default cho_hat_catears = DollCloth("cho", ("head", "hats"), "hat", "catears", [[70, 90, 147, 255]], unlocked=True)
default cho_hat_witch = DollCloth("cho", ("head", "hats"), "hat", "witch", [[71, 51, 102, 255], [215, 170, 98, 255]], unlocked=True)
default cho_accessory4_glasses1 = DollCloth("cho", ("head", "glasses"), "accessory4", "glasses1", [[240, 240, 241, 255]], unlocked=True)
default cho_hat_goggles = DollCloth("cho", ("head", "hats"), "hat", "goggles", [[137, 150, 193, 255], [165, 165, 166, 255]], unlocked=True)
...
default cho_top_sweater1 = DollCloth("cho", ("tops", "school"), "top", "top_sweater_1", [[89, 116, 194, 255], [213, 161, 13, 255]], armfix=True, unlocked=True)
default cho_top_sweater2 = DollCloth("cho", ("tops", "muggle"), "top", "top_sweater_2", [[89, 116, 194, 255]], level=6, unlocked=True)
default cho_top_tanktop1 = DollCloth("cho", ("tops", "muggle"), "top", "top_tanktop_1", [[230, 230, 231, 255]], level=14, unlocked=True)
default cho_robe_quidditch1 = DollCloth("cho", ("tops", "robes"), "robe", "robe_quidditch_1", [[89, 116, 194, 255], [213, 161, 13, 255]], armfix=True, unlocked=True)
default cho_bottom_pants1 = DollCloth("cho", ("bottoms", "trousers"), "bottom", "pants_long_1", [[230, 230, 231, 255]], armfix=True, unlocked=True)
default cho_bottom_shorts2 = DollCloth("cho", ("bottoms", "trousers"), "bottom", "pants_short_2", [[114, 168, 210, 255], [232, 177, 13, 255]], level=10, armfix=True, unlocked=True)
...
default cho_bottom_shorts4 = DollCloth("cho", ("bottoms", "trousers"), "bottom", "pants_short_4", [[109, 105, 121, 255], [213, 161, 13, 255]], level=8, armfix=True, unlocked=True)
