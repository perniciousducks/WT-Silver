...
label cho_intro_E1:
    ...
    call cho_main("Her{w=0.5} \"Quidditch equality movement\".", "soft", "narrow", "angry","down")
    m "Her what now?"
    ...
    call cho_main("Splitting us up into a male and female league would just bring on girls that are just there to flaunt their bodies, instead off taking the sport seriously...", "upset", "narrow", "angry","downR")
    ...
    call cho_main("Anything!", "open", "wide", "angry", "L")
    ...
    call cho_main("{size=-5}Whore...{/size}", "soft", "narrow", "angry", "L",trans=hpunch)
    ...
    if masturbating:
        ...
        call cho_main("What’s that supposed to mean?!?", "scream", "narrow", "angry","L")
        ...
        call cho_main("Though what do I know? I didn’t need to get my teeth shortened so I wouldn’t be confused as a rabbit!", "base", "narrow", "angry","L")
