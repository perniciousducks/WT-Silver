...
label cc_pr_manipulate_girls_T3_katie_intro_part1:
    ...
    cho "So... I bluntly asked her if she was heading to the lake again... to enchant those seaweeds again..."
    ...
    cho "Katie were not just wandering aimlessly and had led me all the way to to the whomping willow."
    m "The whomping whatsit?"
    ...
    cho "And we for a couple of second we just dangled there until I heard a loud snapping sound and a yell."
    g4 "Terrifying!"
    ...
    g9 "The tree spanked her? Seriously?"
    ...
    cho "And just as she did, the tree..."
    cho "Smacked one of its branches against my breasts and stomach..."
    m "But a bit of spanking clearly wouldn't bother a girl as tough as you, would it?"
    cho "I suppose... I’ve taken plenty of bruises playing Quidditch, so this is nothing in comparison..."
    ...
    cho "And when she noticed I was looking at her she just winked at me..."
    ...
    cho "Once the tree lowered me onto the ground again, Katie had already disappeared!"
    cho "I didn’t even get a chance to speak to her!"
    ...
    m "You were both perfectly in sync with each other at that moment..."
    cho "..." #Blushing
    ...
    cho "Whatever that's supposed to mean..." #Smiles and blushes
...
label cc_pr_manipulate_girls_T3_katie_intro_part2:
    ...
    cho "As we walked along I asked her directly if she intended to trick me again."
    cho "But she simply said she's going to the whomping willow, and then continued with hinting that she wouldn’t mind if I joined in..."
    g9 "And, did you?"
    cho "Well, yes..."
    cho "I couldn't really refuse. Not without looking like a total wimp."
    ...
    cho "But before I could, the tree had snaked some of its branches underneath my clothes... and then slipped them right off my body."
    g9 "Nice! Just like that?"
    cho "Well I tried to grab them... but the tree had already moved its branches away from me..."
    ...
    cho "Just eyeing me up and down like a piece of meat... and then..."
    g9 "Yes?"
