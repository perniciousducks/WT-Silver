...
label hg_pf_admire_breasts_T2_masturbate: # Not a Call label
    ...
    call play_music("chipper_doodle") # HERMIONE'S THEME.
    call her_main("[genie_name]?!!", "angry", "wide", "base", "L", ypos="head")
    ...
    menu:
        "\"Leave now, and you'll get no points!\"":
            ...
            call her_main("After {size=+5}this{/size}? Are you kidding me, [genie_name]?", "scream", "wide", "base", "L", cheeks="blush")
            call her_main("I showed you my...", "scream", "wide", "base", "L", cheeks="blush")
...
label hg_pf_admire_breasts_T3_masturbate:
    ...
    menu:
        ...
        "-Just start cumming-":
            g4 "Argh! You whore!"
            call her_main("Proff- ??", "scream", "wide", "base", "L", cheeks="blush")
            call cum_block
            g4 "Argh! YES!"
            hide screen bld1
            with d1
