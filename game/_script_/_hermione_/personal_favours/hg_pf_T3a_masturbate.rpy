...
label hg_pf_strip_T2_fingering:
    ...
    menu:
        ...
        "\"Play with your breasts\"":
            ...
            call her_main("ah...{heart}", "open", "base", "base", "R")
            m "There... Isn't that better?"
            $ hermione_dribble = True
            call her_main("Ah... y-yes...{heart}", "grin", "narrow", "annoyed", "up")
            call set_her_action("covering_top")
            ...
            call her_main("i-{heart}", "base", "narrow", "base", "up", cheeks="blush")
            call set_her_action("lift_breasts")

            call her_main("Ah...{heart} I don't know...", "base", "narrow", "base", "up", cheeks="blush")
            call her_main("To be perfectly honest [genie_name]... I don't think I care...{heart}{heart}{heart}", "silly", "narrow", "base", "up", cheeks="blush")
            m "Really?"
            call set_her_action("covering_top")

            call her_main("Really...{heart}", "silly", "narrow", "base", "up", cheeks="blush")
...
label hg_pf_strip_T4_fingering:
    ...
    menu:
        ...
        "\"What are you thinking about?\"":
            ...
            m "....."
            call her_main("ah...{heart}", "soft", "narrow", "annoyed", "up")
            call set_her_action("pinch")
            ...
            call her_main("The look on his face when he realised he was wrong...{heart}", "soft", "narrow", "annoyed", "up")
            call set_her_action("pinch")

            call her_main("a-ah...{heart}")
            call set_her_action("covering")

            call her_main("It just felt so good!{heart}", "grin", "narrow", "base", "dead")
