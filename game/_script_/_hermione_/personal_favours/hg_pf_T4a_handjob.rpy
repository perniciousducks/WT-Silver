...
label hg_pf_handjob_1:
    ...
    if hg_pf_handjob.points == 0:
        ...
        call her_main("Oh...", "angry", "happyCl", "worried", "mid", emote="05")
        call her_main("......")
    ...
    menu:
        ...
        "\"Give my cock a kiss!\"":
            ...
            call her_main(".............", "angry", "base", "angry", "mid")
            call her_main("...with my lips?", "shock", "wide", "base", "L")
    ...
    menu:
        ...
        "-Give her a warning-":
            ...
            call her_main("What? So soon?!", "shock", "wide", "base", "L")
            ...
            $ aftersperm = True
            call her_main(".......................", "angry", "wide", "base", "L", xpos="right", ypos="base")
            m "..........................."
            ...
            call play_music("chipper_doodle") # HERMIONE'S THEME.
            call her_main("I don't know... I suppose I just panicked...", "angry", "happyCl", "worried", "mid", emote="05")

            if daytime:
                if hermione.is_worn("top"):
                    call her_main("My classes are about to start and I didn't want you to ruin my clothes, [genie_name]...", "angry", "happyCl", "worried", "mid", emote="05")
                    m "So you'll go to classes like this now?"
                    m "With your top all sperm-soaked from the inside?"
                else:
                    call her_main("My classes are about to start and I didn't want you to ruin my face, [genie_name]...", "angry", "happyCl", "worried", "mid", emote="05")
                    m "So you'll go to classes like this now?"
                ...
                call her_main("At this hour The Gryffindor common room will be full of people...", "angry", "happyCl", "worried", "mid", emote="05")
...
label hg_pf_handjob_2:
    ...
    menu:
        ...
        "\"What do you think of my cock?\"":
            ...
            m "Yeah, just a bit."
            call her_main("Sorry...", "angry", "happyCl", "worried", "mid", emote="05")
        ...
        "\"This is really good. Did you practise?\"":
            ...
            call her_main("Actually, yes. I was surprised myself.", "shock", "wide", "base", "L")
...
label hg_pf_handjob_2_cumming:
    ...
    menu:
        ...
        "\"(Yes, I must warn her.)\"":
            ...
            call play_music("chipper_doodle") # HERMIONE'S THEME.
            call her_main("!!!!!!!!!!!", "shock", "wide", "base", "L", ypos="head")
            hide screen bld1
            call ctc
        ...
        "\"(Nah... no need.)\"":
            ...
            call her_main("WHAT?!", "shock", "wide", "base", "L", ypos="head")
            g4 "Take this!"
        ...
        "\"(Cum in her mouth!)\"" if hg_blowjob.trigger == True: # Has done blowjobs already.
            ...
            call her_main("What?!", "open", "wide", "base", "L", ypos="head")
            if hermione.is_worn("top"):
            ...
            call cum_block
            g4 "{size=+5}ARGH! YES!!!{/size}"
            call her_main("*Gulp!-Gulp!-Gulp!*", "full", "wide", "base", "L")
