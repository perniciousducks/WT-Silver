...
label luna_favour_5: #Luna jerks Genie off onto Hermione's face #DONE
    ...
    if lun_whoring <= 11:
        ...
        call her_main("Luna! what are you doing here?", "angry", "wide", "base", "L")
        ...
        call her_main("!!!", "angry", "wide", "base", "L",tears="crying")
        ...
        if luna_addicted == True:
            ...
            call her_main("...what?","mad","wide","base","L",cheeks="blush")
            ...
            call her_main("does that mean...","angry","wide","base","L")
        ...
        call her_main("Really?", "shock", "wide", "base", "L")
        ...
        call her_main("What? I have to spend more time with her?", "soft", "wide", "base", "L")
        ...
        call her_main("no offence, but with your grades the way they are...", "grin", "happyCl", "worried", "mid",emote="05")
        call her_main("well we don't have much time to spare...", "base", "happyCl", "worried", "mid")
        ...
        menu:
            "-Ask about study sessions-":
                ...
                if not luna_herm_talk:
                    ...
                    call her_main("Well, I'd already been testing myself on past years exams since I was a 3rd year.", "grin", "happyCl", "worried", "mid")
