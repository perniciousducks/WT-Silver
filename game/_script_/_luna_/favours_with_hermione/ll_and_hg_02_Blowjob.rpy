...
label luna_favour_6: #luna and hermione blowjob #DONE
    ...
    if lun_whoring == 14: #first time
        ...
        m "Miss granger? Why?"
        call lun_main("well seeing as how this is my first time doing something like this, it only makes sense to have her here to offer her... experience.","base","seductive","base","R")
        ...
        call her_main("I told you that was the rule number one! Besides, you nearly bit it clean in half...", "angry", "wide", "base", "L")
        g4 "!!!"
        ...
        call lun_main("Alright then... hurry up and summon hermione","base","suspicious","sad","R")
