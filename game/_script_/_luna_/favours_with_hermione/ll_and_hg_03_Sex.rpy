...
label luna_favour_7: #Luna and Hermione Sex #DONE
    ...
    menu:
        "-Be gentle...-":
            ...
            $ ccg2 = "herm_7"
            her "Getting {heart}fucked{heart} silly in front of their best friend..."
            $ ccg1 = "luna_6"
            lun "(best?...)"
            $ ccg2 = "herm_8"
    ...
    $ ccg2 = "herm_11"
    her "so{heart}{heart}{heart} goooooooooooood...{heart}"
    $ ccg1 = "luna_8"
    lun "wow..."
    ...
    menu:
        ...
        "-Cum all over her-":
            ...
            $ ccg1 = "luna_42"
            lun "{heart}ah{heart}don't{heart}call{heart}it{heart}nasty...{heart}{heart}{heart}"
            $ ccg2 = "herm_26"
            her "mmmm"
            her "{b}good{/b}"
            $ ccg1 = "luna_43"
