...
label nt_pr_teach_start:
    ...
    if ton_tier == 1:
        ...
        if nt_pr_teach.points == 0:
            call ton_main("So, what's the plan?","open","base","base","R")
            m "The plan?"
            call ton_main("You know, how does this go down?","base","base","base","mid")
            call ton_main("I'm hardly a regular when it comes to this stuff.","open","base","base","mid")
            ...
            call ton_main("A reputation?","open","base","raised","mid")
            call ton_main("Think I'll get a nickname?{w} Maybe they'll call me touchy tonks?","horny","base","base","mid")
            m "Maybe..."
            ...
            call ton_main("I've got some boys to {b}teach{/b}...","horny","base","angry","mid")
...
label nt_pr_teach_T1_E1: #Tier 1 - Event 1 - Slytherin boy
    ...
    call ton_main("It's such a rush!","base","base","base","ahegao")
    call ton_main("I can't believe how naughty I feel!","horny","base","base","ahegao")
    m "So I take it you managed to sneak a peek?"
    call ton_main("Sort of... I didn't really see it.","angry","base","base","R")
    call ton_main("But it was still incredible...","base","base","base","ahegao")
    call ton_main("*Ugh*... that look on his face...","angry","base","base","ahegao")
    ...
    call ton_main("I couldn't tell if he was angry about it, or just scared...","open","base","base","R")
    call ton_main("But, as his teacher, I insisted that he should write out some lines to correct his behaviour...","base","base","base","mid")
    m "Do I need to ask what he had to write?"
    call ton_main("\"I shall not stare at my teacher's big, beautiful breasts\"...","base","base","base","ahegao")
    m "Was the \"big\" and \"beautiful\" part really necessary?"
    call ton_main("Oh, that's not the best bit...","horny","base","base","mid")
    call ton_main("I went on to lecture him just how \"naughty\" and \"wrong\" it is for a student to peek at his teacher's tits,......","base","base","angry","mid")
    call ton_main("Oh, and I made him pull down his trousers while he wrote his lines!","smile","happyCl","base","mid")
    m "So you did see it!"
...
label nt_pr_teach_T1_E2: # Tier 1 - Event 2 - Racenclaw boy
    ...
    call ton_main("*Mmmm*... Long and hard...","horny","base","base","ahegao")
    call ton_main("Just how I like them...","base","base","angry","mid")
    m "I take it you were able to steal a few glances?"
    call ton_main("It was even better than I thought it'd be!","open","closed","base","mid")
    ...
    call ton_main("What? No of course not.{w} Every student is of age here...","open","base","angry","mid")
    call ton_main("And he didn't look like a kid at all down there...","horny","base","base","ahegao")
    call ton_main("(He was so fucking hung!)","upset","base","angry","ahegao")
    call ton_main("It was child's play... Getting what I wanted from him.","base","base","angry","mid")
    m "..................."
    call ton_main("*Mmmm*, I even had him play with himself for a little bit...","horny","base","base","ahegao")
    call ton_main("Fuck, he looked tasty...","open_wide_tongue","base","base","ahegao")
    ...
    call ton_main("I'll try...","smile","happyCl","base","mid")
    call ton_main("(Although, I'll have to play with this one a few more times...)","horny","base","base","ahegao")
...
label nt_pr_teach_T1_E3: # Tier 1 - Event 3 - Two Gryffindor boys. Guess who...
    ...
    m "How'd it go?"
    call ton_main("Great! I even managed to convince two boys to show me their dicks...","base","base","base","mid")
    call ton_main("At the same time!","horny","base","base","mid")
    g9 "Two at once? Congratulations!"
    call ton_main("Yep... To be honest, they probably would have done it for free.","smile","happyCl","base","mid")
    ...
    m "What did they do?"
    call ton_main("*Ugh*... They just wouldn't shut up during the whole lesson!","open","base","base","ahegao")
    call ton_main("And then they tried to lift a girl's skirt with \"wingardium leviosa\"...","open","base","base","R")
    g9 "A classic."
    ...
    call ton_main("I think those poor buggers actually thought I was going to jerk them both off...","horny","base","base","ahegao")
    call ton_main("Still, I think they had a fun time.","base","base","angry","mid")
    m "Any chance they'll tell their friends about it?"
    call ton_main("Oh yes! The Gryffindor common room is probably a buzz already!","base","base","base","ahegao")
    call ton_main("It wouldn't surprise me if I start getting asked to give more boys detention...","horny","base","angry","mid")
    m "Fooling around with and rewarding Gryffindors isn't too helpful for our situation..."
    ...
    call ton_main("Well, I better get back to work, these halls aren't safe unless there's a teacher on patrol.","horny","base","base","mid")
...
label nt_pr_teach_T1_E4: # Tier 1 - Event 4 - Slytherin girl
    ...
    call ton_main("*Umm*... I'm afraid not...","open","base","base","R")
    m "Oh..."
    ...
    call ton_main("Are you that desperate to hear about me \"fooling around\" with my students?","horny","base","angry","mid")
    ...
    m "Just a tad."
    call ton_main("So, I know my job is to try and balance out the favour trading a little...","open","base","base","R")
    call ton_main("But I just couldn't help myself today...","angry","base","worried","R")
    m "Help yourself? You mean..."
    call ton_main("*Ugh*... I don't normally mess around with girls...","open","base","base","down")
    ...
    g9 ".................."
    call ton_main("So, when I felt a pair of cute little eyes struggling their hardest not to stare at me...","horny","base","angry","mid")
    call ton_main("I just {b}had{/b} to play with her!","horny","base","base","ahegao")
    m "*Mmmm*... what happened?"
    call ton_main("Nothing much... I'm pretty sure she would have freaked if I tried anything...","open","base","base","L")
    call ton_main("So I just asked her to stay after class for a little...\"chat.\"","base","base","angry","mid")
    ...
    call ton_main("After that? There's no doubt... She's hooked.","base","base","angry","mid")
    call ton_main("Now I've just got to reel her in.","open","base","base","R")
    call ton_main("If that's all right with you, sir!","base","base","angry","mid")
    ...
    call ton_main("Well, not this time...","open","base","worried","R")
...
label nt_pr_teach_T2_E1: # Tier 2 - Event 1 - Hufflepuff girl
    ...
    call ton_main("Not one! They're not even in any of my classes!","base","base","base","R")
    ...
    call ton_main("Poor thing must have spent hours building up the courage...","open","closed","base","mid")
    m "So what did you buy from her?"
    call ton_main("Well... I asked her what sort of favour she wanted to sell me...","open","base","base","R")
    call ton_main("She was so flustered... And probably didn't plan this far ahead at all...","open","base","worried","mid")
    call ton_main("She started babbling on and on, so I calmed her down by letting her know what favour I wanted...","open","base","base","L")
    ...
    call ton_main("Poor thing only thought to ask how many points she'd be paid after she lifted her skirt though.","smile","happyCl","base","mid")
    call ton_main("I told her five for showing me her panties...","open","base","base","R")
    m "Only five?"
    call ton_main("She said the same. I explained that showing her plain white panties only gets five points.","base","base","angry","mid")
    ...
    m "Did she say yes?"
    call ton_main("She didn't say anything... but she pulled them down all the same...","open","closed","base","mid")
    call ton_main("","base","base","angry","mid")
    ...
    m "...................."
    call ton_main("But she was more than ready to squirt all over my table...","smile","happyCl","base","mid")
    g4 "She did what?!"
    call ton_main("*Ugh*... I had to spend ten whole minutes scourgifying the desk afterwards...","angry","base","worried","down")
    m "*Ah*... Very good..."
    ...
    call ton_main("*Mmmm*... okay then, [ton_genie_name].","base","base","angry","mid")
    call ton_main("I better be on my way as well now...","open","base","base","R")
    call ton_main("(Fuck knows, I could use a bit of \"alone time\" myself...)","base","base","base","ahegao")
...
label nt_pr_teach_T2_E2: # Tier 2 - Event 2 - Ravenclaw boy
    ...
    call ton_main("The teaching was a little dull...","upset","base","base","ahegao")
    call ton_main("Simple wards, hex-detection, basic stuff...","open","base","base","ahegao")
    call ton_main("Not that anyone else would think so, with how much they all struggled with it...","upset","base","angry","R")
    ...
    call ton_main("I don't need to resort to detention anymore... He's learned what a wink in class means.","base","base","angry","mid")
    call ton_main("Plus, I think a few of the other students have worked out what it means as well.","open","base","base","R")
    ...
    call ton_main("He wanted to sell me a kiss today... I almost took him up on it...","horny","base","base","ahegao")
    call ton_main("I think he was a little disappointed when I told him I wanted another look...","open","base","worried","R")
    call ton_main("So I told him I didn't {b}just{/b} want to look at it...","base","base","angry","mid")
    call ton_main("But watch him play with it...","horny","base","angry","mid")
    m "Make him an offer he can't refuse..."
    call ton_main("His eyes truly lit up after that...","base","base","base","ahegao")
    call ton_main("He just kept on staring at me, while he started stroking it...","horny","base","base","mid")
    call ton_main("Getting it hard for his teacher...","horny","base","base","ahegao")
    call ton_main("*Mmmm*... The way he was staring at my tits... with such hunger...","open","base","worried","mid")
    call ton_main("I just {b}had{/b} to get them out for him...","base","base","base","mid")
    g9 "Nice!"
    call ton_main("They got him even more excited...","horny","base","base","ahegao")
    call ton_main("He even started to speak after that...","open","closed","base","mid")
    m "What did he say?"
    ...
    call ton_main("All I said was \"cum for Mommy\"...and he was shot the biggest load towards me.","open","closed","base","mid")
    call ton_main("","base","base","angry","mid")
    m "Fuck... That {b}is{/b} pretty hot..."
    call ton_main("I know...","open","closed","base","mid")
    call ton_main("*Ugh*... I definitely have to go rub one out after this...","angry","base","base","ahegao")
    call ton_main("See you, [ton_genie_name].","base","base","base","mid")
...
label nt_pr_teach_T2_E3: # Tier 2 - Event 3 - Slytherin boy
    ...
    m "I'm intrigued."
    call ton_main("So, I had some cocky little brat from Slytherin cause all sorts of trouble in class.","angry","base","angry","mid")
    ...
    call ton_main("Little bastard cursed me out for that... Disrespected me in front of the entire class...","angry","base","angry","mid")
    ...
    call ton_main("At first the idiot thought I was going to jerk him off...","angry","base","angry","R")
    call ton_main("I might have, if he'd played his cards right...","open","closed","base","mid")
    call ton_main("Instead, his favour wouldn't be nearly as fun.","horny","base","angry","R")
    ...
    call ton_main("That's what he gets, the little shit!","angry","base","angry","down")
    call ton_main("Not only did I leave him blueballed,...I also left him pants down in the class.","base","base","angry","mid")
    m "Forever?"
...
label nt_pr_teach_T2_E4: # Tier 2 - Event 4 - Slytherin girl
    ...
    call ton_main("But there are already some whispers going around school...","base","base","angry","mid")
    call ton_main("And I may or may not have contributed to that...","open","base","base","R")
    m "Very good work."
