label open_gallery():
    ...
    # Door dictionary
    $ character_info = {
        "All": {"ico": "hermione", "flag": True, "active": False, "activity": ""},
        "Tonks": {"ico": "tonks", "flag": tonks_wardrobe_unlocked, "active": False, "activity": ""},
        "Hermione": {"ico": "hermione", "flag": hermione_wardrobe_unlocked, "active": False, "activity": ""},
        "Cho": {"ico": "cho", "flag": cho_wardrobe_unlocked, "active": False, "activity": ""},
        "Luna": {"ico": "luna", "flag": luna_wardrobe_unlocked, "active": False, "activity": ""},
        "Astoria": {"ico": "astoria", "flag": astoria_wardrobe_unlocked, "active": False, "activity": ""},
        "Susan": {"ico": "susan", "flag": susan_wardrobe_unlocked, "active": False, "activity": ""}
    }
