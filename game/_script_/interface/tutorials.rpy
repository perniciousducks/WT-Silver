...
"schedule": ["Outfits Schedule", "Outfits can be assigned into a set schedule, which will allow Hermione to pick what she's going to wear next time you summon her, based on time of day and weather conditions.\n\nYou can assign schedules inside the Wardrobe's Outfits section, by clicking on the icon represented above. \n\nThis feature can be disabled at any time in the wardrobe.", False]}
