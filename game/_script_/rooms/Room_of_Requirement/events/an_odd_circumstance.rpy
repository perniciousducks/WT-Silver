label an_odd_circumstance():
    ...
    #nar "My eyes again, focused on the paper work..." - this line sucks, and isn't necessary. We know that he's doing paperwork
    ...
    show screen white
    with d1
    call her_chibi("stand",200,flip=True)
    hide screen white
    show screen add_overlay
    with d1
    her "Silencio."
    ...
    gen "..."
    nar "I waited a few moments for the pain to emerge..."
    gen "..."
    nar "But it never came..."
    call gen_chibi("hide")
    hide screen desk
    call her_chibi("hide")
    ...
    with d3
    call room("main_room")
    nar "After clearing my throat and composing myself. I sat back down in my chair trying to get my head around what had just transpired."
    hide screen blkfade
    with d3
