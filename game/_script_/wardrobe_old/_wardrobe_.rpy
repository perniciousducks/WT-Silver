...
screen wardrobe_old():
    ...
    imagemap:
        ...
        if wardrobe_page == 0: #default
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+".png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_right_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_right_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 1: #hair
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_hair.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 2: #tops
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_tops.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 3: #bottoms
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_bottoms.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 4: #other clothings
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_stockings.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 5: #accessories
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_accessories.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 6: #underwear
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_underwear.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 7: #outfits
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_outfits.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_outfits_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_outfits_"+str(wardrobe_color)+".png"
        elif wardrobe_page == 8: #gifts
            add "interface/wardrobe/old/"+str(interface_color)+"/icons_"+str(active_girl)+"_gifts.png" zoom 0.5
            ground "interface/wardrobe/old/"+str(interface_color)+"/ground_full_"+str(wardrobe_color)+".png"
            hover "interface/wardrobe/old/"+str(interface_color)+"/hover_full_"+str(wardrobe_color)+".png"
        ...
        for i in range(0,len(wr_background_color)):
            ...
            add "interface/wardrobe/old/icons/colors/"+wr_background_color[i]+".png" xpos 668+(20*col) ypos 560

        #Wardrobe music
        if play_wardrobe_music:
            hotspot (900,150+410,18,18) clicked [SetVariable("play_wardrobe_music",False), Jump("wardrobe_update")]
            add "interface/wardrobe/old/"+str(interface_color)+"/check_true.png" xpos 900 ypos 145+410
        else:
            hotspot (900,150+410,18,18) clicked [SetVariable("play_wardrobe_music",True), Jump("wardrobe_update")]
            add "interface/wardrobe/old/"+str(interface_color)+"/check_false.png" xpos 900 ypos 145+410
        ...
        if wardrobe_chitchat_active:
            add "interface/wardrobe/old/"+str(interface_color)+"/check_true.png" xpos 667 ypos 145+385 #ypos-5 of hotspot ypos
        else:
            add "interface/wardrobe/old/"+str(interface_color)+"/check_false.png" xpos 667 ypos 145+385
...
### Wardrobe Hair & Head Accessories ###
        ...
        if wardrobe_page == 1:
            ...
            add "characters/"+str(active_girl)+"/body/head/"+str(wr_base_hair_style)+"_"+str(wr_base_hair_color)+".png" xpos 10 ypos 102+icon_ypos_offset zoom 0.175
            ...
            if active_girl in ["hermione","luna"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/glasses.png" xpos 75+180 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/ears.png" xpos 75+270 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","astoria","cho","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/hats.png" xpos 75+360 ypos 139 zoom 0.2
            ...
            if wardrobe_head_category == 0 and active_girl in ["hermione","tonks"]: #Hair Color
                for i in range(0,len(wr_haircolor)):
                    ...
                    add "interface/wardrobe/old/icons/colors/"+wr_haircolor[i]+".png" xpos 371+(20*col) ypos (85+(20*row))
            ...
            if wardrobe_head_category == 0:
                ...
                for i in range(0,len(wr_hair)):
                    ...
                    add "characters/"+str(active_girl)+"/body/head/"+wr_hair[i]+"_"+str(wr_base_hair_color)+".png" xpos 10+(90*col) ypos (102+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_head_category == 1:
                ...
                for i in range(0,len(wr_makeup)):
                    ...
                    add "interface/wardrobe/old/icons/items/"+wr_makeup[i]+".png" xpos 0+(90*col) ypos (90+92+(92*row)) zoom 0.3
            ...
            if wardrobe_head_category == 2:
                ...
                for i in range(0,len(wr_glasses)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/glasses/"+wr_glasses[i]+".png" xpos -165+(90*col) ypos (-10+icon_ypos_offset+92+(92*row)) zoom 0.5
            ...
            if wardrobe_head_category == 3:
                ...
                for i in range(0,len(wr_ears)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/ears/"+wr_ears[i]+".png" xpos -30+(90*col) ypos (100+icon_ypos_offset+92+(92*row)) zoom 0.25
            ...
            if wardrobe_head_category == 4:
                ...
                for i in range(0,len(wr_hats)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/hats/hair_"+str(wr_base_hair_style)+"/"+wr_hats[i]+".png" xpos -65+(90*col) ypos (70+icon_ypos_offset+92+(92*row)) zoom 0.3
...
### Wardrope Tops ###
        ...
        if wardrobe_page == 2:
            ...
            add "interface/wardrobe/old/icons/"+str(active_girl)+"/tops_1.png" xpos 75 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/tops_2.png" xpos 75+90 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","cho"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/tops_3.png" xpos 75+180 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/tops_4.png" xpos 75+270 ypos 139 zoom 0.2
            ...
            if wardrobe_tops_category == 0:
                ...
                for i in range(0,len(wr_tops_uniform)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/tops/"+wr_tops_uniform[i]+".png" xpos 15+(90*col) ypos (60+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_tops_category == 1:
                ...
                for i in range(0,len(wr_tops_cheerleader)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/tops/"+wr_tops_cheerleader[i]+".png" xpos 15+(90*col) ypos (60+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_tops_category == 2:
                ...
                for i in range(0,len(wr_tops_normal)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/tops/"+wr_tops_normal[i]+".png" xpos 15+(90*col) ypos (60+92+(92*row)) zoom 0.175
            ...
            if wardrobe_tops_category == 3:
                ...
                for i in range(0,len(wr_tops_wicked)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/tops/"+wr_tops_wicked[i]+".png" xpos 15+(90*col) ypos (60+92+(92*row)) zoom 0.175
...
### Wardrobe Bottoms ###
        ...
        if wardrobe_page == 3:
            ...
            add "interface/wardrobe/old/icons/"+str(active_girl)+"/bottoms_1.png" xpos 75 ypos 139 zoom 0.2
            #text "Uniform" xalign 0.5 xpos 115 ypos 140+75 size 10
            #Cheerleader
            if active_girl in ["hermione","luna"]:
                hotspot (75+90, 139, 83, 85) clicked [SetVariable("wardrobe_bottoms_category",1),Show("wardrobe_old")]
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/bottoms_2.png" xpos 75+90 ypos 139 zoom 0.2
                #text "Cheerleader" xalign 0.5 xpos 115+90 ypos 140+75 size 10
            #Pants
            if active_girl in ["hermione","cho","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/bottoms_4.png" xpos 75+270 ypos 139 zoom 0.2
            ...
            if wardrobe_bottoms_category == 0:
                ...
                for i in range(0,len(wr_bottoms_uniform)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/bottoms/"+wr_bottoms_uniform[i]+".png" xpos 15+(90*col) ypos (17+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_bottoms_category == 1:
                ...
                for i in range(0,len(wr_bottoms_cheerleader)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/bottoms/"+wr_bottoms_cheerleader[i]+".png" xpos 15+(90*col) ypos (17+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_bottoms_category == 3:
                ...
                for i in range(0,len(wr_bottoms_pants)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/bottoms/"+wr_bottoms_pants[i]+".png" xpos 15+(90*col) ypos (17+92+(92*row)) zoom 0.175
...
## Wardrobe Other Clothings ##
        ...
        if wardrobe_page == 4:
            ...
            if active_girl in ["hermione","luna","astoria","susan","cho","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/neck.png" xpos 75 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","cho","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/gloves.png" xpos 75+180 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","astoria","susan","cho","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/stockings.png" xpos 75+270 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","astoria","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/robes.png" xpos 75+360 ypos 139 zoom 0.2
            ...
            if wardrobe_stockings_category == 0:
                ...
                for i in range(0,len(wr_neckwears)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/neckwear/"+str(wr_neckwears[i])+".png" xpos 15+(90*col) ypos 60+icon_ypos_offset+92+(92*row) zoom 0.175
            ...
            if wardrobe_stockings_category == 1:
                ...
                for i in range(0,len(wr_body_accs)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/accs/"+wr_body_accs[i]+".png" xpos 15+(90*col) ypos (60+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_stockings_category == 2:
                ...
                for i in range(0,len(wr_gloves)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/gloves/"+str(wr_gloves[i])+".png" xpos 15+(90*col) ypos 30+icon_ypos_offset+92+(92*row) zoom 0.175
            ...
            if wardrobe_stockings_category == 3:
                ...
                for i in range(0,len(wr_stockings)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/stockings/"+str(wr_stockings[i])+".png" xpos -25+(90*col) ypos -75+92+(92*row) zoom 0.25
            ...
            if wardrobe_stockings_category == 4:
                ...
                for i in range(0,len(wr_robes)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/robe/"+str(wr_robes[i])+".png" xpos 45+(90*col) ypos 77+92+(92*row) zoom 0.125
        ...
        if wardrobe_page == 5:
            ...
            if wardrobe_accessories_category == 0:
                ...
                for i in range(0,len(wr_potions_list)):
                    ...
                    add "interface/wardrobe/old/icons/potions/"+wr_potions_list[i]+".png" xpos 65+(90*col) ypos (138+92+(92*row)) zoom 0.8
            ...
            if wardrobe_accessories_category == 3:
                ...
                for i in range(0,len(wr_piercings_list)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/piercings/"+wr_piercings_list[i]+".png" xpos 15+(90*col) ypos (70+92+(92*row)) zoom 0.175
            ...
            if wardrobe_accessories_category == 4:
                ...
                for i in range(0,len(wr_tattoos_list)):
                    ...
                    add "characters/"+str(active_girl)+"/body/tattoos/"+wr_tattoos_list[i]+".png" xpos 15+(90*col) ypos (60+92+(92*row)) zoom 0.175
...
## Wardrobe Underwear ##
        ...
        if wardrobe_page == 6:
            ...
            add "interface/wardrobe/old/icons/"+str(active_girl)+"/underwear_1.png" xpos 75 ypos 139 zoom 0.2
            ...
            add "interface/wardrobe/old/icons/"+str(active_girl)+"/underwear_2.png" xpos 75+90 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","astoria","susan","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/underwear_3.png" xpos 75+180 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","cho"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/underwear_4.png" xpos 75+270 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","astoria","susan","cho","tonks"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/stockings.png" xpos 75+360 ypos 139 zoom 0.2
            ...
            if wardrobe_underwear_category == 0:
                ...
                for i in range(0,len(wr_bras)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/bras/"+wr_bras[i]+".png" xpos 15+(90*col) ypos (55+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_underwear_category == 1:
                ...
                for i in range(0,len(wr_panties)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/panties/"+wr_panties[i]+".png" xpos 15+(90*col) ypos (17+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_underwear_category == 2:
                ...
                for i in range(0,len(wr_onepieces)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/onepieces/"+wr_onepieces[i]+".png" xpos 15+(90*col) ypos (47+icon_ypos_offset+92+(92*row)) zoom 0.175
            ...
            if wardrobe_underwear_category == 3:
                ...
                for i in range(0,len(wr_garterbelts)):
                    ...
                    add "characters/"+str(active_girl)+"/clothes/garterbelts/"+wr_garterbelts[i]+".png" xpos 15+(90*col) ypos (17+icon_ypos_offset+92+(92*row)) zoom 0.175
...
## Wardrobe Outfits ##
        ...
        if wardrobe_page == 7:
            ...
            if active_girl in ["hermione","luna","astoria","susan","cho"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/outfits_1.png" xpos 75 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","astoria","susan","cho"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/outfits_2.png" xpos 75+90 ypos 139 zoom 0.2
            ...
            if active_girl in ["hermione","luna","astoria","susan","cho"]:
                ...
                add "interface/wardrobe/old/icons/"+str(active_girl)+"/outfits_3.png" xpos 75+180 ypos 139 zoom 0.2
            ...
            #
                ...
                #add "interface/wardrobe/old/icons/"+str(active_girl)+"/outfits_4.png" xpos 75+270 ypos 139 zoom 0.2
            ...
            #    add "interface/wardrobe/old/icons/"+str(active_girl)+"/outfits_5.png" xpos 75+360 ypos 139 zoom 0.2
            ...
            #        add "interface/wardrobe/old/icons/colors/base.png" xpos 371 ypos 85 zoom 1.5
            #        add "interface/wardrobe/old/icons/colors/blue.png" xpos 348 ypos 96
            ...
            #        add "interface/wardrobe/old/icons/colors/base.png" xpos 371 ypos 85
            #        add "interface/wardrobe/old/icons/colors/blue.png" xpos 348 ypos 96 zoom 1.5
            ...
            #            add "interface/wardrobe/old/icons/"+str(active_girl)+"/outfits/mannequin.png" xpos 31+(90*col) ypos 131+92+(179*row) zoom 0.155
