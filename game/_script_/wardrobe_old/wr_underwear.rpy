        ...
        # if wardrobe_chitchat_active:
            ...
            # if underwear_choice in ["bra_base"]:
                ...
                # else: #Fail
                    ...
                    # m "Why not?"
                    # call her_main("Why not?!", "shock", "wide", "base", "L")
            ...
            # elif underwear_choice in ["bra_tape"]:
                ...
                # else: #Fail
                    # if her_whoring < 11:
                        ...
                        # call her_main("It's those Blast-Ended Skrewts again, isn't it?!", "soft", "wide", "base", "L",trans=hpunch)
            ...
            # elif underwear_choice in ["panties_fishnet","panties_fishnet_string"]:
                ...
                # else: #Fail
                    ...
                    # else:
                        ...
                        # call her_main("What?!", "open", "wide", "base", "L")
                        # call her_main("This doesn't even cover anything!!!", "soft", "wide", "base", "L")
